  ...
  <view class="header">
    ...
    <view class="navbar" :class="{'navbar-mini':!matchLeftWindow,'popup-menu':popupMenuOpened}">
      ...
      <view class="navbar-right pointer">
        ...
        <picker class="navbar-right-item-gap" mode="selector" :range="themes" range-key="text" :value="themeIndex"
          @change="changeTheme">
        ...
        <view class="" style="position: relative;">
          <view v-show="userInfo.nickname || userInfo.username || userInfo.mobile || userInfo.email" class="navbar-user"
