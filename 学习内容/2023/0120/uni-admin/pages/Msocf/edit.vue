  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      ...
      <uni-forms-item name="name" label="品牌" required>
        <uni-easyinput placeholder="请输入品牌名" v-model="formData.name" trim="both"></uni-easyinput>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("z_id,parent_id,name,socvalue,status,type").get().then((res) => {
