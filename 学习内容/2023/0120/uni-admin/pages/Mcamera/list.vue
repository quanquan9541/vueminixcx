        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
          ...
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'Comeraedit')" sortable
              @sort-change="sortChange($event, 'Comeraedit')">详情</uni-th>
            <uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'Comeravalue')" sortable
              @sort-change="sortChange($event, 'Comeravalue')">数值</uni-th>
            <uni-th align="center" filter-type="range" @filter-change="filterChange($event, 'Comeraadd')" sortable
              @sort-change="sortChange($event, 'Comeraadd')">附加分</uni-th>
