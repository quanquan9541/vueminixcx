      ...
      <unicloud-db ref="udb" :collection="collectionList" :where="where" page-data="replace"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection" @selection-change="selectionChange">
          <uni-tr>
            ...
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'goods_desc')" sortable @sort-change="sortChange($event, 'goods_desc')">配料</uni-th>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'url')" sortable @sort-change="sortChange($event, 'url')">图文</uni-th>
            <uni-th align="center" filter-type="timestamp" @filter-change="filterChange($event, 'add_date')" sortable @sort-change="sortChange($event, 'add_date')">日期</uni-th>
...
<script>
  import { enumConverter, filterToWhere } from '../../js_sdk/validator/tea-milk-list.js';
