  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      <uni-forms-item name="category_id" label="品牌">
        <uni-data-picker v-model="formData.category_id" collection="tea-milk-class" field="_id as value, name as text"></uni-data-picker>
      </uni-forms-item>
      ...
      <uni-forms-item name="pic" label="大图" required>
        <uni-file-picker file-mediatype="image" file-extname="jpg,png" :limit="3" return-type="array" v-model="formData.pic"></uni-file-picker>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/tea-milk-list.js';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("category_id,name,pic,goods_desc,url,add_date,state").get().then((res) => {
