  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      <uni-forms-item name="z_id" label="厂商">
        <uni-data-picker placeholder="请选择厂商" v-model="formData.z_id.value" popup-title="请选择厂商"
          collection="Manufacturer_brand" :where="zwhere" field="_id as value, name as text" :step-searh="true"
          self-field="_id" @change="zonchange">
        </uni-data-picker>
      </uni-forms-item>
      <uni-forms-item name="parent_id" label="品牌">
        <uni-data-picker placeholder="请选择品牌" v-model="formData.parent_id.value" popup-title="请选择品牌"
          collection="Manufacturer_brand" :where="pwhere" field="_id as value, name as text" :step-searh="true"
          self-field="_id" @change="ponchange">
        </uni-data-picker>
      </uni-forms-item>
