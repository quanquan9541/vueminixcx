  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validateTrigger="bind">
      <uni-forms-item name="name" label="品牌" required>
        <uni-easyinput placeholder="请输入品牌" v-model="formData.name" trim="both"></uni-easyinput>
      </uni-forms-item>
      <uni-forms-item name="url" label="官网">
...
<script>
  ...
  const dbCollectionName = 'tea-milk-class';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("name,url,logo,sort,state").get().then((res) => {
