<template>
  <view>
    ...
    <view class="uni-container">
      <unicloud-db ref="udb" :collection="collectionList" field="parent_id,name,pic,status,type" :where="where"
        ...
        <uni-table ref="table" :loading="loading" :emptyText="error.message || '没有更多数据'" border stripe type="selection"
          ...
          <uni-tr>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'parent_id')" sortable
              @sort-change="sortChange($event, 'parent_id')">厂商</uni-th>
            <uni-th align="center" filter-type="search" @filter-change="filterChange($event, 'name')" sortable
              @sort-change="sortChange($event, 'name')">品牌</uni-th>
            <uni-th align="center" sortable @sort-change="sortChange($event, 'pic')">Logo</uni-th>
