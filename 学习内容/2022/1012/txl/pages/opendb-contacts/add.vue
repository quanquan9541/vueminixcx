  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="add" label="地址">
        <uni-data-picker self-field="code" parent-field="parent_code" v-model="formData.add" collection="opendb-city-china" field="name as text,code as value"></uni-data-picker>
      </uni-forms-item>
