  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="education" label="学历">
        <uni-data-checkbox v-model="formData.education" :localdata="formOptions.education_localdata"></uni-data-checkbox>
      </uni-forms-item>
      <uni-forms-item name="environment" label="工作环境">
        <uni-data-checkbox v-model="formData.environment" :localdata="formOptions.environment_localdata"></uni-data-checkbox>
      </uni-forms-item>
      ...
      <uni-forms-item name="colleague" label="同事质量">
        <uni-data-checkbox v-model="formData.colleague" :localdata="formOptions.colleague_localdata"></uni-data-checkbox>
      </uni-forms-item>
      <uni-forms-item name="occupation" label="职业资格">
        <uni-data-checkbox v-model="formData.occupation" :localdata="formOptions.occupation_localdata"></uni-data-checkbox>
      </uni-forms-item>
...
<script>
  import { validator } from '../../js_sdk/validator/work.js';
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("money,date,time,gowork,education,environment,sex,ssex,colleague,occupation,special").get().then((res) => {
