...
var _taiji = _interopRequireDefault(__webpack_require__(/*! ./pages/taiji/taiji.vue */ 203));
// @ts-ignore
...
/* harmony import */ var _taiji_vue_vue_type_template_id_76ecb53e_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./taiji.vue?vue&type=template&id=76ecb53e&scoped=true& */ 204);
/* harmony import */ var _taiji_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./taiji.vue?vue&type=script&lang=js& */ 206);
...
/* harmony import */ var _taiji_vue_vue_type_style_index_0_id_76ecb53e_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taiji.vue?vue&type=style&index=0&id=76ecb53e&lang=scss&scoped=true& */ 210);
...
var _colorGradient = _interopRequireDefault(__webpack_require__(/*! ../../uni_modules/uview-ui/libs/function/colorGradient.js */ 69));
var _mixin = __webpack_require__(/*! ../../uni_modules/uview-ui/libs/mixin/mixin.js */ 48);
//
//
//
//
...
var yinyangdata = __webpack_require__(/*! @/datalist/yinyang.json */ 209);
var _default = {
  data: function data() {
    return {
      dadad: yinyangdata,
  ...
  methods: {
    ...
    copyText: function copyText() {
      var text = this.zip.guaming.name;
      this.Copy(text);
    },
    //复制窗
    ...
    fate: function fate() {
      ...
      if (!this.zip.guaming) {
        ...
        if ((0, _tools.dateFormat)(new Date(), 'yyyyMMdd') - this.zip.ymd < 1) {
          // console.log('一天一次');
          uni.showToast({
            title: '一天只能测算一次哦!~',
            icon: "none",
