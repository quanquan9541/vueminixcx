      ...
      <uni-forms ref="work" :modelValue="worklist">
        ...
        <uni-section class="section" title="时间部分" type="line">
          ...
          <uni-section title="9:00 - 18:00为正常作息" titleFontSize="10px" titleColor="#55aaff" type="circle">
            ...
            <!-- 夜班判断 -->
            <uni-forms-item class="item" label="是否夜班" label-width="75px" name="night" v-if="morning==1">
        ...
        <uni-section class="section" title="人文部分" type="line">
          ...
          <uni-section title="看脸" titleFontSize="10px" titleColor="#55aaff" type="circle">
  ...
  export default {
    ...
    methods: {
      ...
      calculation() {
        ...
        let time = Math.floor(weekday * (duration + commute - (loaf / 2)) * (1 + ((morning + night) / 4))) //时间
        // console.log(time)
        this.time = time
