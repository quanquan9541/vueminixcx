  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="ydate" label="">
        <uni-datetime-picker return-type="date" v-model="formData.ydate"></uni-datetime-picker>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("username,gender,mobile,email,comment,ydate").get().then((res) => {
