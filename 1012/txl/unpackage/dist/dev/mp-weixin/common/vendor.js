...
const p = h('{\n    "address": [\n        "127.0.0.1",\n        "192.168.31.147"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**/*.js",\n        "C:/yl/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), m = h('[{"provider":"aliyun","spaceName":"ldlz12","spaceId":"ce91c6a1-a80c-4508-8d93-e8f762ad6e25","clientSecret":"GYZG3CISrb4xOSRv6sjU+g==","endpoint":"https://api.bspapp.com"}]') || [];
let _ = "";
try {
  _ = "__UNI__19E2853";
} catch (e2) {
