  ...
  <view class="uni-container">
    <uni-forms ref="form" :model="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="fdate" label="返回日期">
        <uni-datetime-picker type="date" return-type="date" v-model="formData.fdate"></uni-datetime-picker>
      </uni-forms-item>
      <uni-forms-item name="add" label="地址">
        <uni-data-picker placeholder="请选择出发地址" popup-title="请选择城市" self-field="code" parent-field="parent_code"
          v-model="formData.add" collection="opendb-city-china" orderby="value asc"
      ...
      <uni-forms-item name="photo" label="健康码">
        <uni-file-picker file-mediatype="image" file-extname="jpg,png" return-type="object" v-model="formData.photo">
        </uni-file-picker>
      </uni-forms-item>
