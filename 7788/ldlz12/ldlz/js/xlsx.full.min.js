...
function make_xlsx_lib(e) {
	...
	var A = (function() {
		return (
			typeof Buffer !== 'undefined' && typeof undefined !== 'undefined' && typeof {} !== 'undefined' && !!{}.node
		);
	})();
	var E = (function() {
	...
	function C(e) {
		if (A) return Buffer.alloc ? Buffer.alloc(e) : new Buffer(e);
		return typeof Uint8Array != 'undefined' ? new Uint8Array(e) : new Array(e);
	}
	function y(e) {
		if (A) return Buffer.allocUnsafe ? Buffer.allocUnsafe(e) : new Buffer(e);
		return typeof Uint8Array != 'undefined' ? new Uint8Array(e) : new Array(e);
	}
	var S = function Xw(e) {
		if (A) return E(e, 'binary');
	...
	function de(e, r, t) {
		var a = r.replace(ue, ''),
			n = r.length - a.length;
		return Ne(e, a, t * Math.pow(10, 2 * n)) + Ar('%', n);
	}
	function ve(e, r, t) {
		var a = r.length - 1;
	...
	function me(e, r, t) {
		...
		return (
			...
			' ' +
			(s === 0
				? Ar(' ', e[1].length + 1 + e[4].length)
				: M(s, e[1].length) + e[2] + '/' + e[3] + L(f, e[4].length))
		);
	}
	function be(e, r, t) {
	...
	function _e(e, r, t) {
		...
		var i,
			...
			o = Math.abs(t),
			l = t < 0 ? '-' : '';
		if (r.match(/^00+$/)) return l + z(o, r.length);
		if (r.match(/^[#?]+$/)) {
			n = z(t, 0);
			if (n === '0') n = '';
			return n.length > r.length ? n : Ae(r.substr(0, r.length - n.length)) + n;
		}
		if ((i = r.match(ge))) return me(i, o, l);
		if (r.match(/^#+0+$/)) return l + z(o, r.length - r.indexOf('0'));
		if ((i = r.match(we))) {
			n = Ee(t, i[1].length)
				.replace(/^([^\.]+)$/, '$1.' + Ae(i[1]))
				.replace(/\.$/, '.' + Ae(i[1]))
				.replace(/\.(\d*)$/, function(e, r) {
					return '.' + r + Ar('0', Ae(i[1]).length - r.length);
				});
		...
		if ((i = r.match(/^#{1,3},##0(\.?)$/))) return l + he(z(o, 0));
		if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
			return t < 0
				? '-' + _e(e, r, -t)
				: he('' + (Math.floor(t) + ye(t, i[1].length))) + '.' + L(Ce(t, i[1].length), i[1].length);
		}
		if ((i = r.match(/^#,#*,#0/))) return _e(e, r.replace(/^#,#*,/, ''), t);
		if ((i = r.match(/^([0#]+)(\\?-([0#]+))+$/))) {
			n = P(_e(e, r.replace(/[\\-]/g, ''), t));
			s = 0;
			return P(
				P(r.replace(/\\/g, '')).replace(/[0#]/g, function(e) {
		...
		if ((i = r.match(/^([#0?]+)( ?)\/( ?)([#0?]+)/))) {
			...
			n += c + i[2] + '/' + i[3];
			c = U(f[2], s);
			if (c.length < i[4].length) c = Ae(i[4].substr(i[4].length - c.length)) + c;
			n += c;
			return n;
		}
		if ((i = r.match(/^# ([#0?]+)( ?)\/( ?)([#0?]+)/))) {
			...
			return (
				...
				(f[0] || (f[1] ? '' : '0')) +
				' ' +
				(f[1] ? M(f[1], s) + i[2] + '/' + i[3] + U(f[2], s) : Ar(' ', 2 * s + 1 + i[2].length + i[3].length))
			);
		}
		if ((i = r.match(/^[#0?]+$/))) {
			n = z(t, 0);
			if (r.length <= n.length) return n;
			return Ae(r.substr(0, r.length - n.length)) + n;
		}
		if ((i = r.match(/^([#0?]+)\.([#0]+)$/))) {
			...
			return Ae(r.substr(0, h) + n + r.substr(r.length - u));
		}
		if ((i = r.match(/^00,000\.([#0]*0)$/))) {
			s = Ce(t, i[1].length);
			return t < 0
				? '-' + _e(e, r, -t)
				: he(Se(t)).replace(/^\d,\d{3}$/, '0$&').replace(/^\d*$/, function(e) {
	...
	function Ie(e, r, t) {
		...
		var i,
			...
			o = Math.abs(t),
			l = t < 0 ? '-' : '';
		if (r.match(/^00+$/)) return l + L(o, r.length);
		if (r.match(/^[#?]+$/)) {
			n = '' + t;
			if (t === 0) n = '';
			return n.length > r.length ? n : Ae(r.substr(0, r.length - n.length)) + n;
		}
		if ((i = r.match(ge))) return be(i, o, l);
		if (r.match(/^#+0+$/)) return l + L(o, r.length - r.indexOf('0'));
		if ((i = r.match(we))) {
			n = ('' + t).replace(/^([^\.]+)$/, '$1.' + Ae(i[1])).replace(/\.$/, '.' + Ae(i[1]));
		...
		if ((i = r.match(/^#{1,3},##0(\.?)$/))) return l + he('' + o);
		if ((i = r.match(/^#,##0\.([#0]*0)$/))) {
			return t < 0 ? '-' + Ie(e, r, -t) : he('' + t) + '.' + Ar('0', i[1].length);
		}
		...
		if ((i = r.match(/^00,000\.([#0]*0)$/))) {
			return t < 0
				? '-' + Ie(e, r, -t)
				: he('' + t).replace(/^\d,\d{3}$/, '0$&').replace(/^\d*$/, function(e) {
						return '00,' + (e.length < 3 ? L(0, 3 - e.length) : '') + e;
					}) +
					'.' +
					L(0, i[1].length);
		...
		switch (r) {
			...
			default:
				if (r.match(/\.[0#?]*$/))
					return Ie(e, r.slice(0, r.lastIndexOf('.')), t) + Ae(r.slice(r.lastIndexOf('.')));
		}
		throw new Error('unsupported format |' + r + '|');
	}
	function Ne(e, r, t) {
		return (t | 0) === t ? Ie(e, r, t) : _e(e, r, t);
	}
	function Fe(e) {
		var r = [];
		var t = false;
	...
	function Le(e, r, t, a) {
		...
		for (s = 0; s < n.length; ++s) {
			switch (n[s].t) {
				...
				case 'b':
				case 'Z':
					n[s].v = ce(n[s].t.charCodeAt(0), n[s].v, l, m);
					n[s].t = 't';
					break;
				case 'n':
				case '?':
	...
	var Ze = (function Yw() {
		...
		function b(e, r, t, a, n, i, s, f) {
			...
			for (; h < c.length; h += 128) {
				...
				if (b !== 0) m.ct = w(p, p.l - 8);
				var k = p._R(2) + p._R(2) + p._R(2) + p._R(2);
				if (k !== 0) m.mt = w(p, p.l - 8);
				m.start = p._R(4, 'i');
				m.size = p._R(4, 'i');
		...
		function x(e, r) {
			var t = r && r.type;
			if (!t) {
				if (A && Buffer.isBuffer(e)) t = 'buffer';
			}
			switch (t || 'base64') {
				case 'file':
					return _(e, r);
		...
		function P(e, r) {
			...
			for (i = 1; i < e.FileIndex.length; ++i) {
				...
				if (c.size >= 4096) {
					n.l = (c.start + 1) << 9;
					if (A && Buffer.isBuffer(c.content)) {
		...
		function j(e, r) {
			...
			switch ((r && r.type) || 'buffer') {
				...
				case 'buffer':
					if (A) return Buffer.isBuffer(t) ? t : E(t);
				case 'array':
					return typeof t == 'string' ? S(t) : t;
			}
			return t;
		}
		var X;
		...
		function Te(e) {
			var r = ma(50 + Math.floor(e.length * 1.1));
			var t = ke(e, r);
			return r.slice(0, t);
		}
		...
		function We(e, r) {
			...
			var t = (r && r.root) || '';
			var a = (A && Buffer.isBuffer(e) ? e.toString('binary') : G(e)).split('\r\n');
			var n = 0,
				i = '';
		...
		function He(e, r) {
			...
			for (var o = 1; o < e.FullPaths.length; ++o) {
				...
				var l = f.content;
				var c = A && Buffer.isBuffer(l) ? l.toString('binary') : G(l);
				var h = 0,
	...
	function tr(e, r, t) {
		if (typeof Qe !== 'undefined' && Qe.writeFileSync)
			return t ? Qe.writeFileSync(e, r, t) : Qe.writeFileSync(e, r);
		...
		if (typeof Blob !== 'undefined') {
			var n = new Blob([ rr(a) ], { type: 'application/octet-stream' });
	...
	var lr = new Date(1899, 11, 30, 0, 0, 0);
	function cr(e, r) {
		var t = e.getTime();
		if (r) t -= 1462 * 24 * 60 * 60 * 1e3;
		var a = lr.getTime() + (e.getTimezoneOffset() - lr.getTimezoneOffset()) * 6e4;
		return (t - a) / (24 * 60 * 60 * 1e3);
	}
	var hr = new Date();
	var ur = lr.getTime() + (hr.getTimezoneOffset() - lr.getTimezoneOffset()) * 6e4;
	var dr = hr.getTimezoneOffset();
	function vr(e) {
		var r = new Date();
		r.setTime(e * 24 * 60 * 60 * 1e3 + ur);
	...
	var gr = new Date('2017-02-19T19:06:09.000Z');
	var mr = isNaN(gr.getFullYear()) ? new Date('2/19/17') : gr;
	var br = mr.getFullYear() == 2017;
	function wr(e, r) {
		var t = new Date(e);
		if (br) {
		...
		if (mr.getFullYear() == 1917 && !isNaN(t.getFullYear())) {
			var a = t.getFullYear();
	...
	function kr(e, r) {
		if (A && Buffer.isBuffer(e)) {
			if (r) {
				...
				if (e[1] == 254 && e[2] == 255) return pt(u(e.slice(2).toString('binary')));
			}
	...
	var Cr = /^(0?\d|1[0-2])(?:|:([0-5]?\d)(?:|(\.\d+)(?:|:([0-5]?\d))|:([0-5]?\d)(|\.\d+)))([ap])m?/;
	function yr(e) {
		if (!e[2]) return new Date(1900, 0, 0, +e[1] % 12 + (e[7] == 'p' ? 12 : 0), 0, 0, 0);
		if (e[3]) {
			if (e[4])
				return new Date(1900, 0, 0, +e[1] % 12 + (e[7] == 'p' ? 12 : 0), +e[2], +e[4], parseFloat(e[3]) * 1e3);
	...
	function _r(e) {
		...
		if (r.match(/jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec/)) {
			...
			if (r.length > 3 && Sr.indexOf(r) == -1) return i;
	...
	function Or(e) {
		...
		if (e.asNodeBuffer && A) return d(e.asNodeBuffer().toString('binary'));
	...
	function Rr(e) {
		...
		if (e.asNodeBuffer && A) return e.asNodeBuffer();
	...
	function Ir(e) {
		return e && e.name.slice(-4) === '.bin' ? Rr(e) : Or(e);
	}
	function Nr(e, r) {
	...
	function Wr(e, r) {
		switch (r.type) {
			case 'base64':
				return Ze.read(e, { type: 'base64' });
			case 'binary':
				return Ze.read(e, { type: 'binary' });
			case 'buffer':
			case 'array':
				return Ze.read(e, { type: 'buffer' });
		}
	...
	var vt = (A && ((ut(dt) == ct(dt) && ut) || (ht(dt) == ct(dt) && ht))) || ct;
	var pt = A
		? function(e) {
	...
	var At = /(^\s|\s$|\n)/;
	function Et(e, r) {
		return '<' + e + (r.match(At) ? ' xml:space="preserve"' : '') + '>' + r + '</' + e + '>';
	}
	function Ct(e) {
		return nr(e)
			.map(function(r) {
	...
	function yt(e, r, t) {
		return (
			...
			e +
			(t != null ? Ct(t) : '') +
			(r != null ? (r.match(At) ? ' xml:space="preserve"' : '') + '>' + r + '</' + e : '/') +
			'>'
		);
	}
	function St(e, r) {
	...
	function _t(e, r) {
		switch (typeof e) {
			case 'string':
				var t = yt('vt:lpwstr', tt(e));
				if (r) t = t.replace(/&quot;/g, '_x0022_');
				return t;
			case 'number':
				return yt((e | 0) == e ? 'vt:i4' : 'vt:r8', tt(String(e)));
			case 'boolean':
				return yt('vt:bool', e ? 'true' : 'false');
		}
		if (e instanceof Date) return yt('vt:filetime', St(e));
		throw new Error('Unable to serialize ' + e);
	}
	function xt(e) {
		if (A && Buffer.isBuffer(e)) return e.toString('utf8');
		if (typeof e === 'string') return e;
		if (typeof Uint8Array !== 'undefined' && e instanceof Uint8Array) return vt(x(R(e)));
	...
	if (A) {
		...
		ra = function nk(e) {
			return (
				Buffer.isBuffer(e) || Array.isArray(e) || (typeof Uint8Array !== 'undefined' && e instanceof Uint8Array)
			);
		};
	}
	function ta() {
	...
	function la(e, t) {
		...
		switch (t) {
			case 'dbcs':
				h = this.l;
				if (A && Buffer.isBuffer(this)) n = this.slice(this.l, this.l + 2 * e).toString('utf16le');
				else
					for (c = 0; c < e; ++c) {
						n += String.fromCharCode(na(this, h));
						h += 2;
					}
				e *= 2;
				break;
			...
			case 'wstr':
				...
				else return la.call(this, e, 'dbcs');
				e = 2 * e;
				break;
			case 'lpstr-ansi':
				n = Gt(this, this.l);
			...
			case 'dbcs-cont':
				...
				for (c = 0; c < e; ++c) {
					if (this.lens && this.lens.indexOf(h) !== -1) {
						o = aa(this, h);
						this.l = h + 1;
						l = la.call(this, e - c, o ? 'dbcs-cont' : 'sbcs-cont');
						return f.join('') + l;
					}
					f.push(v(na(this, h)));
					h += 2;
	...
	function da(e, r, n) {
		var i = 0,
			s = 0;
		if (n === 'dbcs') {
			for (s = 0; s != r.length; ++s) ua(this, r.charCodeAt(s), this.l + 2 * s);
			i = 2 * r.length;
		} else if (n === 'sbcs') {
	...
	function Ea(e, r) {
		...
		if (!e.rRel && e.rRel != null) t = _a(t);
		return t;
	}
	function Ca(e, r) {
		if (e.s.r == 0 && !e.s.rRel) {
			if (e.e.r == (r.biff >= 12 ? 1048575 : r.biff >= 8 ? 65536 : 16384) && !e.e.rRel) {
				return (e.s.cRel ? '' : '$') + Ra(e.s.c) + ':' + (e.e.cRel ? '' : '$') + Ra(e.e.c);
			}
		}
		if (e.s.c == 0 && !e.s.cRel) {
			if (e.e.c == (r.biff >= 12 ? 16383 : 255) && !e.e.cRel) {
				return (e.s.rRel ? '' : '$') + Sa(e.s.r) + ':' + (e.e.rRel ? '' : '$') + Sa(e.e.r);
			}
		}
		return Ea(e.s, r.biff) + ':' + Ea(e.e, r.biff);
	}
	if (typeof cptable !== 'undefined') g(cptable);
	...
	function La(e) {
		var r = e.indexOf(':');
		if (r == -1) return { s: Da(e), e: Da(e) };
		return { s: Da(e.slice(0, r)), e: Da(e.slice(r + 1)) };
	}
	function Ma(e, r) {
	...
	function Ba(e, r) {
		...
		if (e.z != null)
			try {
				return (e.w = We(e.z, t ? cr(r) : r));
			} catch (a) {}
		try {
			return (e.w = We((e.XF || {}).numFmtId || (t ? 14 : 0), t ? cr(r) : r));
		} catch (a) {
			return '' + r;
		}
	}
	...
	var Wn = {
		1: { n: 'CodePage', t: _n },
		2: { n: 'Category', t: Mn },
		3: { n: 'PresentationFormat', t: Mn },
		4: { n: 'ByteCount', t: xn },
		5: { n: 'LineCount', t: xn },
		6: { n: 'ParagraphCount', t: xn },
		7: { n: 'SlideCount', t: xn },
		8: { n: 'NoteCount', t: xn },
		9: { n: 'HiddenCount', t: xn },
		10: { n: 'MultimediaClipCount', t: xn },
		11: { n: 'ScaleCrop', t: On },
		12: { n: 'HeadingPairs', t: Pn },
		13: { n: 'TitlesOfParts', t: Ln },
		14: { n: 'Manager', t: Mn },
		15: { n: 'Company', t: Mn },
		16: { n: 'LinksUpToDate', t: On },
		17: { n: 'CharacterCount', t: xn },
		19: { n: 'SharedDoc', t: On },
		22: { n: 'HyperlinksChanged', t: On },
		23: { n: 'AppVersion', t: xn, p: 'version' },
		24: { n: 'DigSig', t: Fn },
		26: { n: 'ContentType', t: Mn },
		27: { n: 'ContentStatus', t: Mn },
		28: { n: 'Language', t: Mn },
		29: { n: 'Version', t: Mn },
		255: {},
	...
	var Hn = {
		...
		16: { n: 'CharCount', t: xn },
		17: { n: 'Thumbnail', t: Dn },
		18: { n: 'Application', t: Mn },
		19: { n: 'DocSecurity', t: xn },
		255: {},
		2147483648: { n: 'Locale', t: In },
		2147483651: { n: 'Behavior', t: In },
		1919054434: {}
	...
	function Qn(e, r, t) {
		...
		if (!t) {
			n[n.length] = zr;
			n[n.length] = yt('Types', null, { xmlns: Rt.CT, 'xmlns:xsd': Rt.xsd, 'xmlns:xsi': Rt.xsi });
			n = n.concat(
				[
					[ 'xml', 'application/xml' ],
		...
		var o = function(r) {
			(e[r] || []).forEach(function(e) {
				n[n.length] = yt('Override', null, { PartName: (e[0] == '/' ? '' : '/') + e, ContentType: a[r][0] });
			});
		};
		s('workbooks');
		f('sheets');
	...
	function ai(e) {
		var r = [ zr, yt('Relationships', null, { xmlns: Rt.RELS }) ];
		nr(e['!id']).forEach(function(t) {
			r[r.length] = yt('Relationship', null, e['!id'][t]);
		});
		if (r.length > 2) {
	...
	function fi(e) {
		...
		for (var t = 0; t < e.length; ++t)
			r.push(
				'  <manifest:file-entry manifest:full-path="' + e[t][0] + '" manifest:media-type="' + e[t][1] + '"/>\n'
			);
	...
	function gi(e, r) {
		...
		if (e) {
			if (e.CreatedDate != null)
				pi(
					'dcterms:created',
					typeof e.CreatedDate === 'string' ? e.CreatedDate : St(e.CreatedDate, t.WTF),
			...
			if (e.ModifiedDate != null)
				pi(
					'dcterms:modified',
					typeof e.ModifiedDate === 'string' ? e.ModifiedDate : St(e.ModifiedDate, t.WTF),
					{ 'xsi:type': 'dcterms:W3CDTF' },
					a,
					n
				);
	...
	var bi = [ 'Worksheets', 'SheetNames', 'NamedRanges', 'DefinedNames', 'Chartsheets', 'ChartNames' ];
	function wi(e, r, t, a) {
		var n = [];
	...
	function Ti(e) {
		...
		r[r.length] = zr;
		r[r.length] = yt('Properties', null, { xmlns: Rt.EXT_PROPS, 'xmlns:vt': Rt.vt });
	...
	function Ci(e) {
		var r = [ zr, yt('Properties', null, { xmlns: Rt.CUST_PROPS, 'xmlns:vt': Rt.vt }) ];
		if (!e) return r.join('');
		var t = 1;
		nr(e).forEach(function a(n) {
			++t;
			r[r.length] = yt('property', _t(e[n], true), {
	...
	function xi(e, r) {
		...
		nr(yi)
			.map(function(e) {
				for (var r = 0; r < ui.length; ++r) if (ui[r][1] == e) return ui[r];
				for (r = 0; r < mi.length; ++r) if (mi[r][1] == e) return mi[r];
				throw e;
			})
			.forEach(function(a) {
				...
				t.push(Et(yi[a[1]] || a[1], n));
			});
		return yt('DocumentProperties', t.join(''), { xmlns: Nt.o });
	}
	function Oi(e, r) {
		...
		if (e)
			nr(e).forEach(function(r) {
				...
				for (a = 0; a < mi.length; ++a) if (r == mi[a][1]) return;
				...
				n.push(yt(at(r), i, { 'dt:dt': s }));
			});
		if (r)
			nr(r).forEach(function(t) {
	...
	function Gi(e, r, t) {
		...
		e.l += 2;
		if (r !== Rn)
			if (a !== r && Bn.indexOf(r) === -1 && !((r & 65534) == 4126 && (a & 65534) == 4126))
	...
	function ji(e, r) {
		...
		switch (e) {
			...
			case 31:
			case 80:
				a = ma(4 + 2 * (r.length + 1) + (r.length % 2 ? 0 : 2));
				a._W(4, r.length + 1);
				a._W(0, r, 'dbcs');
	...
	function Ki(e, r, t) {
		...
		if (!r) {
			...
			for (f = 0; f < e.length; ++f) {
				var h = e[f][0];
				o = ma(4 + 4 + 2 * (h.length + 1) + (h.length % 2 ? 0 : 2));
				o._W(4, f + 2);
				o._W(4, h.length + 1);
				o._W(0, h, 'dbcs');
		...
		for (f = 0; f < e.length; ++f) {
			...
			if ($i.indexOf(e[f][0]) > -1 || bi.indexOf(e[f][0]) > -1) continue;
	...
	function Ji(e, r, t) {
		...
		var l = a._R(4);
		var c = a._R(16);
		if (c !== Ze.utils.consts.HEADER_CLSID && c !== t) throw new Error('Bad PropertySet CLSID ' + c);
		n = a._R(4);
	...
	function qs(e, r) {
		...
		t._W(4, e.Unique);
		var a = [];
		for (var n = 0; n < e.length; ++n) a[n] = cs(e[n], r);
		var i = I([ t ].concat(a));
	...
	function gf(e, r, t, a) {
		var n = t && t.biff == 5;
		if (!a) a = ma(n ? 3 + r.length : 5 + 2 * r.length);
		a._W(2, e);
		a._W(n ? 1 : 2, r.length);
		if (!n) a._W(1, 1);
	...
	function Lf(e, r, t) {
		...
		var l = hs(e, s, t);
		if (n & 32) l = Pf[l.charCodeAt(0)];
		var c = a - e.l;
		if (t && t.biff == 2) --c;
		var h = a == e.l || f === 0 || !(c > 0) ? [] : dd(e, c, t, f);
	...
	function Mf(e, r, t) {
		...
		var a = [],
			n = e.l + r,
			i = e._R(t.biff > 8 ? 4 : 2);
		while (i-- !== 0) a.push(Os(e, t.biff > 8 ? 12 : 6, t));
	...
	function Jf(e, r, t) {
		...
		try {
			...
			for (var l = 1; l < e.lens.length - 1; ++l) {
				...
				var c = e[e.l];
				var h = hs(e, e.lens[l + 1] - e.lens[l] - 1);
				n += h;
	...
	var Co = [ 2, 3, 48, 49, 131, 139, 140, 245 ];
	var yo = (function() {
		var e = {
			1: 437,
			2: 850,
		...
		function l(e, a) {
			...
			var i = wa();
			var s = mw(e, { header: 1, raw: true, cellDates: true });
			var l = s[0],
				c = s.slice(1),
				h = e['!cols'] || [];
			var u = 0,
	...
	var So = (function() {
		...
		var r = new RegExp(
			'N(' + nr(e).join('|').replace(/\|\|\|/, '|\\||').replace(/([?()+])/g, '\\$1') + '|\\|)',
			'gm'
		);
		var t = function(r, t) {
			var a = e[t];
		...
		function i(e, r) {
			switch (r.type) {
				...
				case 'binary':
					return s(e, r);
				case 'buffer':
					return s(A && Buffer.isBuffer(e) ? e.toString('binary') : x(e), r);
				case 'array':
					return s(kr(e), r);
			}
			throw new Error('Unrecognized type ' + r.type);
		...
		function s(e, i) {
			...
			var w = 0,
				k;
			var T = { Workbook: { WBProps: {}, Names: [] } };
			if (+i.codepage >= 0) o(+i.codepage);
			for (; c !== s.length; ++c) {
				w = 0;
				var A = s[c].trim().replace(/\x1B([\x20-\x2F])([\x30-\x3F])/g, n).replace(r, t);
				var E = A.replace(/;;/g, '\0').split(';').map(function(e) {
					return e.replace(/\u0000/g, ';');
				});
				var C = E[0],
					y;
									...
									case 'V':
										{
											...
											if (S >= 1 && S <= 4) T.Workbook.WBProps.date1904 = true;
										}
										break;
								}
							break;
								...
								for (h = 1; h < E.length; ++h)
									switch (E[h].charAt(0)) {
										case 'N':
											...
											break;
										case 'E':
											_.Ref = ((i && i.sheet) || 'Sheet1') + '!' + Oh(E[h].slice(1));
											break;
									}
								T.Workbook.Names.push(_);
							}
							break;
						case 'C':
							var x = false,
							...
							for (h = 1; h < E.length; ++h)
								switch (E[h].charAt(0)) {
									...
									case 'K':
										y = E[h].slice(1);
										if (y.charAt(0) === '"') y = y.slice(1, y.length - 1);
										else if (y === 'TRUE') y = true;
										else if (y === 'FALSE') y = false;
										else if (!isNaN(Er(y))) {
											y = Er(y);
											if (v !== null && Pe(v)) y = vr(T.Workbook.WBProps.date1904 ? y + 1462 : y);
										} else if (!isNaN(_r(y).getDate())) {
											y = wr(y);
										}
										if (
											typeof a !== 'undefined' &&
											...
											y = a.utils.decode(i.codepage, y);
										x = true;
										break;
									case 'E':
										I = true;
										var D = Oh(E[h].slice(1), { r: f, c: l });
										u[f][l] = [ u[f][l], D ];
										break;
									case 'S':
										R = true;
							...
							if (x) {
								if (u[f][l] && u[f][l].length == 2) u[f][l][0] = y;
								else u[f][l] = y;
								v = null;
							}
							if (R) {
		...
		function c(e, r) {
			r.forEach(function(r, t) {
				...
				if (r.hidden) a += '0';
					...
					if (typeof r.width == 'number' && !r.wpx) r.wpx = Ol(r.width);
					if (typeof r.wpx == 'number' && !r.wch) r.wch = Rl(r.wpx);
		...
		function e(e, t) {
			switch (t.type) {
				...
				case 'binary':
					return r(e, t);
				case 'buffer':
					return r(A && Buffer.isBuffer(e) ? e.toString('binary') : x(e), t);
				case 'array':
					return r(kr(e), t);
			}
			...
			for (; i !== t.length; ++i) {
				...
				switch (+o) {
					...
					case 0:
						...
						else if (!isNaN(Er(l))) s[a][n] = Er(l);
						else if (!isNaN(_r(l).getDate())) s[a][n] = wr(l);
						else s[a][n] = l;
						++n;
						break;
					case 1:
					...
					for (var o = n.s.c; o <= n.e.c; ++o) {
						...
						switch (i.t) {
							...
							case 's':
								...
								break;
							case 'd':
								if (!i.w) i.w = We(i.z || Y[14], cr(wr(i.v)));
								if (b) r(a, 0, i.w, 'V');
								else r(a, 1, 0, i.w);
								break;
							default:
	...
	var Oo = (function() {
		function e(e, r, t, a, n) {
			...
			else if (!isNaN(_r(e).getDate())) r[t][a] = wr(e);
			else r[t][a] = e;
		}
		function r(r, t) {
			var a = t || {};
		...
		function s(e, r) {
			...
			var c = 0,
				...
				v = 0,
				p = e.charCodeAt(0);
			var g = t.dateNF != null ? $e(t.dateNF) : null;
			function b() {
				var r = e.slice(c, h);
				...
				if (r.length === 0) a.t = 'z';
					...
					a.t = 'b';
					a.v = false;
				} else if (!isNaN((l = Er(r)))) {
					a.t = 'n';
					if (t.cellText !== false) a.w = r;
					a.v = l;
				} else if (!isNaN(_r(r).getDate()) || (g && r.match(g))) {
					a.z = t.dateNF || Y[14];
					var i = 0;
					if (g && r.match(g)) {
						r = Ye(r, t.dateNF, r.match(g) || []);
						i = 1;
					}
					if (t.cellDates) {
						a.t = 'd';
					...
					if (t.cellText !== false) a.w = We(a.z, a.v instanceof Date ? cr(a.v) : a.v);
		...
		function o(e, r) {
			var t = '',
				n = r.type == 'string' ? [ 0, 0, 0, 0 ] : jb(e, r);
			switch (r.type) {
				case 'base64':
					t = T(e);
					break;
				...
				case 'buffer':
					...
					else t = A && Buffer.isBuffer(e) ? e.toString('binary') : x(e);
					break;
				case 'array':
					t = kr(e);
					break;
			...
			if (t.slice(0, 19) == 'socialcalc:version:') return xo.to_sheet(r.type == 'string' ? t : vt(t), r);
			return f(t, r);
		}
		function l(e, r) {
			return Ha(o(e, r), r);
	...
	function Ro(e, r) {
		...
		t.WTF = true;
		try {
			var n = So.to_workbook(e, t);
			t.WTF = a;
			return n;
		} catch (i) {
			t.WTF = a;
			if (!i.message.match(/SYLK bad record ID/) && a) throw i;
			return Oo.to_workbook(e, r);
		}
	}
	var Io = (function() {
		function e(e, r, t) {
				...
				e(
					...
					function(e, r, t) {
						switch (t) {
							...
							case 15:
							case 51:
								if (((!a.qpro && !a.works) || t == 51) && e[1].v.charCodeAt(0) < 48)
									e[1].v = e[1].v.slice(1);
							...
							case 16:
								...
								var c = a.dense ? (n[e[0].r] || [])[e[0].c] : n[Pa(e[0])];
								if (c) {
									c.t = e[1].t;
									c.v = e[1].v;
		...
		function a(e, r) {
			...
			for (var h = n.s.r; h <= c; ++h) {
				...
				for (var v = n.s.c; v <= n.e.c; ++v) {
					...
					if (!m || m.t == 'z') continue;
					if (m.t == 'n') {
						if ((m.v | 0) == m.v && m.v >= -32768 && m.v <= 32767) hm(a, 13, p(h, v, m.v));
						else hm(a, 14, b(h, v, m.v));
					} else {
						var w = Wa(m);
						hm(a, 15, u(h, v, w.slice(0, 239)));
					}
				}
			}
			hm(a, 1);
		...
		function n(e, r) {
			...
			for (var n = 0, i = 0; n < e.SheetNames.length; ++n)
				if ((e.Sheets[e.SheetNames[n]] || {})['!ref']) hm(a, 27, W(e.SheetNames[n], i++));
			var f = 0;
	...
	function Go(e, r) {
		if (!r.bookSST) return '';
		var t = [ zr ];
		t[t.length] = yt('sst', null, { xmlns: It[0], count: e.Count, uniqueCount: e.Unique });
		for (var a = 0; a != e.length; ++a) {
	...
	function sl(e) {
		...
		switch (r.Minor) {
			case 2:
				return [ r.Minor, fl(e, r) ];
			case 3:
				return [ r.Minor, ol(e, r) ];
			case 4:
				return [ r.Minor, ll(e, r) ];
		}
	...
	function cl(e, r) {
		...
		var n = e._R(4);
		r -= 4;
		t.EncryptionHeader = nl(e, n);
		r -= n;
		t.EncryptionVerifier = il(e, r);
		return t;
	}
	function hl(e) {
		var r = {};
	...
	function gl(e, r, t, a) {
		var n = { key: as(e), verificationBytes: as(e) };
		if (t.password) n.verifier = ul(t.password);
		a.valid = n.verificationBytes === n.verifier;
		if (a.valid) a.insitu = pl(t.password);
		return n;
	}
	function ml(e, r, t) {
		var a = t || {};
		a.Info = e._R(2);
		e.l -= 2;
		if (a.Info === 1) a.Data = hl(e, r);
		else a.Data = cl(e, r);
		return a;
	}
	function bl(e, r, t) {
		var a = { Type: t.biff >= 8 ? e._R(2) : 0 };
		if (a.Type) ml(e, r - 2, a);
		else gl(e, t.biff >= 8 ? r : r - 2, t, a);
		return a;
	}
	var wl = (function() {
		function e(e, t) {
		...
		function r(e, r) {
			...
			n.forEach(function(e, r) {
				...
				while ((s = t.exec(e))) {
					...
					if (l.charCodeAt(0) == 32) l = l.slice(1);
	...
	var yl = 6,
		...
		xl = yl;
	function Ol(e) {
		return Math.floor((e + Math.round(128 / xl) / 256) * xl);
	}
	function Rl(e) {
		return Math.floor((e - 5) / xl * 100 + 0.5) / 100;
	}
	function Il(e) {
		return Math.round((e * xl + 5) / xl * 256) / 256;
	}
	function Nl(e) {
		return Il(Rl(Ol(e)));
	}
	function Fl(e) {
		var r = Math.abs(e - Nl(e)),
			t = xl;
		if (r > 0.005)
			for (xl = _l; xl < Sl; ++xl)
				if (Math.abs(e - Nl(e)) <= r) {
					r = Math.abs(e - Nl(e));
					t = xl;
				}
		xl = t;
	...
	function Wl(e, r, t, a) {
		...
		(e[0].match(Xr) || []).forEach(function(e) {
			...
			switch (Jr(t[0])) {
				...
				case '<border/>':
					n = {};
					if (t.diagonalUp) n.diagonalUp = lt(t.diagonalUp);
					if (t.diagonalDown) n.diagonalDown = lt(t.diagonalDown);
					r.Borders.push(n);
					break;
				case '</border>':
					break;
		...
		(e[0].match(Xr) || []).forEach(function(e) {
			...
			switch (Jr(f[0])) {
				...
				case '</name>':
					break;
				case '<b':
					n.bold = f.val ? lt(f.val) : 1;
					break;
				case '<b/>':
					n.bold = 1;
					break;
				case '<i':
					n.italic = f.val ? lt(f.val) : 1;
					break;
				case '<i/>':
					n.italic = 1;
					break;
				...
				case '<u/>':
					...
					break;
				case '<strike':
					n.strike = f.val ? lt(f.val) : 1;
					break;
				case '<strike/>':
					n.strike = 1;
					break;
				case '<outline':
					n.outline = f.val ? lt(f.val) : 1;
					break;
				case '<outline/>':
					n.outline = 1;
					break;
				case '<shadow':
					n.shadow = f.val ? lt(f.val) : 1;
					break;
				case '<shadow/>':
					n.shadow = 1;
					break;
				case '<condense':
					n.condense = f.val ? lt(f.val) : 1;
					break;
				case '<condense/>':
					n.condense = 1;
					break;
				case '<extend':
					n.extend = f.val ? lt(f.val) : 1;
					break;
				case '<extend/>':
					n.extend = 1;
					break;
				...
				case '<color':
					if (!n.color) n.color = {};
					if (f.auto) n.color.auto = lt(f.auto);
					if (f.rgb) n.color.rgb = f.rgb.slice(-6);
						...
						if (f.theme && t.themeElements && t.themeElements.clrScheme) {
							n.color.rgb = Cl(t.themeElements.clrScheme[n.color.theme].rgb, n.color.tint || 0);
						}
					}
					break;
				case '<color/>':
	...
	function Gl(e) {
		...
		[ [ 5, 8 ], [ 23, 26 ], [ 41, 44 ], [ 50, 392 ] ].forEach(function(t) {
			for (var a = t[0]; a <= t[1]; ++a)
				if (e[a] != null) r[r.length] = yt('numFmt', null, { numFmtId: a, formatCode: tt(e[a]) });
		});
		if (r.length === 1) return '';
		r[r.length] = '</numFmts>';
		r[0] = yt('numFmts', null, { count: r.length - 2 }).replace('/>', '>');
		return r.join('');
	}
	var jl = [ 'numFmtId', 'fillId', 'fontId', 'borderId', 'xfId' ];
	var Xl = [
		'applyAlignment',
		'applyBorder',
		'applyFill',
		...
		(e[0].match(Xr) || []).forEach(function(e) {
			...
			switch (Jr(i[0])) {
				...
				case '<xf/>':
					a = i;
					delete a[0];
					for (s = 0; s < jl.length; ++s) if (a[jl[s]]) a[jl[s]] = parseInt(a[jl[s]], 10);
					for (s = 0; s < Xl.length; ++s) if (a[Xl[s]]) a[Xl[s]] = lt(a[Xl[s]]);
				...
				case '<alignment/>':
					...
					if (i.wrapText) f.wrapText = lt(i.wrapText);
					a.alignment = f;
					break;
				case '</alignment>':
					break;
	...
	function Yl(e) {
		var r = [];
		r[r.length] = yt('cellXfs', null);
		e.forEach(function(e) {
			r[r.length] = yt('xf', null, e);
		});
		r[r.length] = '</cellXfs>';
		if (r.length === 2) return '';
		r[0] = yt('cellXfs', null, { count: r.length - 2 }).replace('/>', '>');
		return r.join('');
	}
	var Kl = (function sk() {
		...
		return function i(s, f, o) {
			...
			var c;
			if ((c = s.match(e))) Vl(c, l, o);
			if ((c = s.match(a))) zl(c, l, f, o);
			if ((c = s.match(t))) Hl(c, l, f, o);
			if ((c = s.match(n))) Wl(c, l, f, o);
			if ((c = s.match(r))) $l(c, l, o);
			return l;
		};
	})();
	function Jl(e, r) {
		var t = [ zr, yt('styleSheet', null, { xmlns: It[0], 'xmlns:vt': Rt.vt }) ],
			a;
		...
		if ((a = Yl(r.cellXfs))) t[t.length] = a;
	...
	var ac = ga;
	function nc(e, r) {
		if (!r) r = ma(4 * 3 + 8 * 7 + 16 * 1);
		if (!tc) tc = sr(rc);
		var t = tc[e.patternType];
		if (t == null) t = 40;
		r._W(4, t);
		var a = 0;
		if (t != 40) {
			...
			switch (o) {
				...
				case 43:
					...
					if (e.color.theme != null && r && r.themeElements && r.themeElements.clrScheme) {
						e.color.rgb = Cl(r.themeElements.clrScheme[e.color.theme].rgb, e.color.tint || 0);
					}
					break;
				case 1025:
					break;
	...
	function dc(e, r) {
		...
		ka(e, 615, ja(t));
		[ [ 5, 8 ], [ 23, 26 ], [ 41, 44 ], [ 50, 392 ] ].forEach(function(t) {
			for (var a = t[0]; a <= t[1]; ++a) if (r[a] != null) ka(e, 44, Zl(a, r[a]));
		});
		ka(e, 616);
	}
	function vc(e) {
		...
		if (r == 0) return;
		ka(e, 611, ja(r));
		ka(e, 43, ec({ sz: 12, color: { theme: 1 }, name: 'Calibri', family: 2, scheme: 'minor' }));
		ka(e, 612);
	}
	function pc(e) {
		var r = 2;
		if (r == 0) return;
		ka(e, 603, ja(r));
		ka(e, 45, nc({ patternType: 'none' }));
		ka(e, 45, nc({ patternType: 'gray125' }));
		ka(e, 604);
	}
	function gc(e) {
		var r = 1;
	...
	function mc(e) {
		var r = 1;
		ka(e, 626, ja(r));
		ka(e, 47, sc({ numFmtId: 0, fontId: 0, fillId: 0, borderId: 0 }, 65535));
		ka(e, 627);
	}
	function bc(e, r) {
	...
	function Tc(e) {
		var r = 0;
		ka(e, 508, hc(r, 'TableStyleMedium9', 'PivotStyleMedium4'));
		ka(e, 509);
	}
	function Ac() {
		return;
	...
	function yc(e, r, t) {
		...
		(e[0].match(Xr) || []).forEach(function(e) {
			...
			switch (n[0]) {
				...
				case '</a:folHlink>':
					if (n[0].charAt(1) === '/') {
						r.themeElements.clrScheme[Cc.indexOf(n[0])] = a;
						a = {};
					} else {
	...
	function Sc() {}
	function _c() {}
	var xc = /<a:clrScheme([^>]*)>[\s\S]*<\/a:clrScheme>/;
	var Oc = /<a:fontScheme([^>]*)>[\s\S]*<\/a:fontScheme>/;
	var Rc = /<a:fmtScheme([^>]*)>[\s\S]*<\/a:fmtScheme>/;
	function Ic(e, r, t) {
		r.themeElements = {};
		var a;
		[ [ 'clrScheme', xc, yc ], [ 'fontScheme', Oc, Sc ], [ 'fmtScheme', Rc, _c ] ].forEach(function(n) {
			if (!(a = e.match(n[1]))) throw new Error(n[0] + ' not found in themeElements');
			n[2](a, r, t);
		});
	}
	var Nc = /<a:themeElements([^>]*)>[\s\S]*<\/a:themeElements>/;
	function Fc(e, r) {
		if (!e || e.length === 0) e = Dc();
		var t;
		var a = {};
		if (!(t = e.match(Nc))) throw new Error('themeElements not found in theme');
		Ic(t[0], a, r);
		a.raw = e;
		return a;
	}
	...
	function Vc(e, r) {
		return { flags: e._R(4), version: e._R(4), name: Xa(e, r - 8) };
	}
	function Gc(e) {
		var r = ma(12 + 2 * e.name.length);
		r._W(4, e.flags);
		r._W(4, e.version);
		$a(e.name, r);
		return r.slice(0, r.l);
	...
	function qc() {
		...
		ka(e, 332);
		ka(e, 334, ja(1));
		ka(e, 335, Gc({ name: 'XLDAPR', version: 12e4, flags: 3496657072 }));
		ka(e, 336);
		ka(e, 339, $c(1, 'XLDAPR'));
		ka(e, 52);
		ka(e, 35, ja(514));
	...
	function sh(e, r) {
		...
		var n = [
			yt('xml', null, { 'xmlns:v': Nt.v, 'xmlns:o': Nt.o, 'xmlns:x': Nt.x, 'xmlns:mv': Nt.mv }).replace(
				/\/>/,
				'>'
			),
			...
			n.push(
				yt(
					...
					[
						...
						yt('v:path', null, { gradientshapeok: 't', 'o:connecttype': 'rect' })
					].join(''),
	...
	function fh(e, r) {
		...
		var n = a.type == 'gradient' ? yt('o:fill', null, { type: 'gradientUnscaled', 'v:ext': 'view' }) : null;
		var i = yt('v:fill', n, a);
		...
		return [
			...
			'<x:MoveWithCells/>',
			'<x:SizeWithCells/>',
			Et('x:Anchor', [ t.c + 1, 0, t.r + 1, 0, t.c + 3, 20, t.r + 5, 20 ].join(',')),
			Et('x:AutoFill', 'False'),
			Et('x:Row', String(t.r)),
			Et('x:Column', String(t.c)),
	...
	function ch(e) {
		var r = [ zr, yt('comments', null, { xmlns: It[0] }) ];
		var t = [];
		r.push('<authors>');
		e.forEach(function(e) {
		...
		e.forEach(function(e) {
			...
			if (n.length <= 1) r.push(Et('t', tt(n[0] || '')));
			else {
				var i = 'Comment:\n    ' + n[0] + '\n';
	...
	function uh(e, r, t) {
		var a = [ zr, yt('ThreadedComments', null, { xmlns: Rt.TCMNT }).replace(/[\/]>/, '>') ];
		e.forEach(function(e) {
			var n = '';
			(e[1] || []).forEach(function(i, s) {
				...
				a.push(yt('threadedComment', Et('text', i.t || ''), f));
			});
		});
	...
	function vh(e) {
		var r = [ zr, yt('personList', null, { xmlns: Rt.TCMNT, 'xmlns:x': It[0] }).replace(/[\/]>/, '>') ];
	...
	var Th = 'application/vnd.ms-office.vbaProject';
	function Ah(e) {
		var r = Ze.utils.cfb_new({ root: 'R' });
	...
	var Ch = [ 'xlsb', 'xlsm', 'xlam', 'biff8', 'xla' ];
	function yh() {
		return { '!type': 'dialog' };
	}
	function Sh() {
	...
	var Rh = /(^|[^._A-Z0-9])([$]?)([A-Z]{1,2}|[A-W][A-Z]{2}|X[A-E][A-Z]|XF[A-D])([$]?)(10[0-3]\d{4}|104[0-7]\d{3}|1048[0-4]\d{2}|10485[0-6]\d|104857[0-6]|[1-9]\d{0,5})(?![_.\(A-Za-z0-9])/g;
	var Ih = (function() {
		return function e(r, t) {
			return r.replace(Rh, function(e, r, a, n, i, s) {
				var f = Oa(n) - (a ? 0 : t.c);
				var o = ya(s) - (i ? 0 : t.r);
				var l = o == 0 ? '' : !i ? '[' + o + ']' : o + 1;
				var c = f == 0 ? '' : !a ? '[' + f + ']' : f + 1;
	...
	function Nh(e, r) {
		return e.replace(Rh, function(e, t, a, n, i, s) {
			return t + (a == '$' ? a + n : Ra(Oa(n) + r.c)) + (i == '$' ? i + s : Sa(ya(s) + r.r));
		});
	}
	function Fh(e, r, t) {
		var a = La(r),
	...
	function Uh(e, r, t) {
		var a = 2;
		if (t) {
			if (t.biff >= 2 && t.biff <= 5) return Bh(e, r, t);
	...
	function Hh(e, r, t) {
		if (t && t.biff >= 2 && t.biff <= 5) return zh(e, r, t);
	...
	function hu(e, r, t) {
		var a = e[e.l++];
		var n = e._R(1),
			i = t && t.biff <= 3 ? [ a == 88 ? -1 : 0, e._R(1) ] : uu(e);
		return [ n, (i[0] === 0 ? yd : Cd)[i[1]] ];
	}
	function uu(e) {
	...
	function Tu(e, r, t) {
		var a = e._R(t.biff == 12 ? 4 : 2);
		var n = [];
		for (var i = 0; i != a; ++i) n.push((t.biff == 12 ? gn : Ns)(e, 8));
		return n;
	}
	function Au(e, r, t) {
		var a = 0,
		...
		for (var i = 0, s = []; i != a && (s[i] = []); ++i) for (var f = 0; f != n; ++f) s[i][f] = ku(e, t.biff);
		return s;
	}
	function Eu(e, r, t) {
		var a = (e._R(1) >>> 5) & 3;
	...
	var Qu = {
		...
		18: { n: 'PtgUplus', f: Lh },
		19: { n: 'PtgUminus', f: Lh },
		20: { n: 'PtgPercent', f: Lh },
		21: { n: 'PtgParen', f: Lh },
		22: { n: 'PtgMissArg', f: Lh },
		23: { n: 'PtgStr', f: wu },
		26: { n: 'PtgSheet', f: Yu },
		...
		41: { n: 'PtgMemFunc', f: _u },
		42: { n: 'PtgRefErr', f: xu },
		43: { n: 'PtgAreaErr', f: Yh },
		44: { n: 'PtgRefN', f: ou },
		45: { n: 'PtgAreaN', f: Jh },
		46: { n: 'PtgMemAreaN', f: Ju },
		47: { n: 'PtgMemNoMemN', f: qu },
		57: { n: 'PtgNameX', f: Cu },
		58: { n: 'PtgRef3d', f: lu },
		59: { n: 'PtgArea3d', f: $h },
		60: { n: 'PtgRefErr3d', f: Ou },
		61: { n: 'PtgAreaErr3d', f: Kh },
		255: {}
	};
	var ed = {
		64: 32,
	...
	var rd = {
		...
		6: { n: 'PtgElfRwV', f: Gu },
		7: { n: 'PtgElfColV', f: Uu },
		10: { n: 'PtgElfRadical', f: Wu },
		11: { n: 'PtgElfRadicalS', f: zu },
	...
	var td = {
		0: { n: 'PtgAttrNoop', f: Zu },
		1: { n: 'PtgAttrSemi', f: au },
		2: { n: 'PtgAttrIf', f: ru },
		4: { n: 'PtgAttrChoose', f: Qh },
		8: { n: 'PtgAttrGoto', f: eu },
		16: { n: 'PtgAttrSum', f: du },
		32: { n: 'PtgAttrBaxcel', f: Zh },
		33: { n: 'PtgAttrBaxcel', f: Zh },
		64: { n: 'PtgAttrSpace', f: iu },
		65: { n: 'PtgAttrSpaceSemi', f: su },
		128: { n: 'PtgAttrIfError', f: tu },
		255: {}
	};
	function ad(e, r, t, a) {
		if (a.biff < 8) return ga(e, r);
		var n = e.l + r;
		var i = [];
	...
	function vd(e, r, t) {
		...
		var n,
			i = e._R(2);
		var s = nd(e, i, t);
		if (i == 65535) return [ [], ga(e, r - 2) ];
		if (r !== i + 2) n = ad(e, a - i - 2, s, t);
		return [ s, n ];
	}
	function pd(e) {
		var r;
		if (na(e, e.l + 6) !== 65535) return [ bn(e), 'n' ];
		switch (e[e.l]) {
			case 0:
				e.l += 8;
				return [ 'String', 's' ];
	...
	function xd(e) {
		var r = 'of:=' + e.replace(Rh, '$1[.$2$3$4$5]').replace(/\]:\[/g, ':');
	...
	function Ud(e, r, t, a, n, i) {
		...
		if ((!a || a.cellText !== false) && e.t !== 'z')
			try {
				...
				} else if (e.t === 'd') e.w = We(r, cr(e.v), Nd);
		...
		if (t != null)
			try {
				...
				if (e.s.fgColor && e.s.fgColor.theme && !e.s.fgColor.rgb) {
					e.s.fgColor.rgb = Cl(n.themeElements.clrScheme[e.s.fgColor.theme].rgb, e.s.fgColor.tint || 0);
					if (a.WTF) e.s.fgColor.raw_rgb = n.themeElements.clrScheme[e.s.fgColor.theme].rgb;
				}
				if (e.s.bgColor && e.s.bgColor.theme) {
					e.s.bgColor.rgb = Cl(n.themeElements.clrScheme[e.s.bgColor.theme].rgb, e.s.bgColor.tint || 0);
	...
	function qd(e, r, t, a, n, i, s) {
		...
		var u = l.match(Yd);
		if (u) Qd(u[0], f, n, t);
		else if ((u = l.match(Kd))) ev(u[0], u[1] || '', f, n, t, s, i);
		var d = (l.match(/<(?:\w*:)?dimension/) || { index: -1 }).index;
		if (d > 0) {
			var v = l.slice(d, d + 50).match(Gd);
			if (v) Wd(f, v[1]);
		}
		var p = l.match(Jd);
		if (p && p[1]) dv(p[1], n);
		...
		if (h) gv(h[1], f, r, o, i, s);
		var w = c.match(Xd);
		if (w) f['!autofilter'] = cv(w[0]);
		var k = [];
		var T = c.match(Hd);
		if (T) for (d = 0; d != T.length; ++d) k[d] = Ua(T[d].slice(T[d].indexOf('"') + 1));
		var A = c.match(Vd);
		if (A) iv(f, A, a);
		var E = c.match($d);
		if (E) f['!margins'] = sv(Kr(E[0]));
	...
	function rv(e, r, t, a, n) {
		...
		if (e && e['!outline']) {
			...
			f = (f || '') + yt('outlinePr', null, c);
		}
		if (!i && !f) return;
		n[n.length] = yt('sheetPr', f, s);
	}
	...
	function nv(e) {
		...
		if (e.password) r.password = ul(e.password).toString(16).toUpperCase();
		return yt('sheetProtection', null, r);
	}
	function iv(e, r, t) {
	...
	function fv(e) {
		Ld(e);
		return yt('pageMargins', null, e);
	}
	function ov(e, r) {
		var t = false;
		for (var a = 0; a != r.length; ++a) {
			var n = Kr(r[a], true);
			if (n.hidden) n.hidden = lt(n.hidden);
	...
	function hv(e, r, t, a) {
		...
		return yt('autoFilter', null, { ref: n });
	}
	var uv = /<(?:\w:)?sheetView(?:[^>a-z][^>]*)?\/?>/;
	function dv(e, r) {
		if (!r.Views) r.Views = [ {} ];
		(e.match(uv) || []).forEach(function(e, t) {
			var a = Kr(e);
			if (!r.Views[t]) r.Views[t] = {};
			if (+a.zoomScale) r.Views[t].zoom = +a.zoomScale;
			if (a.rightToLeft && lt(a.rightToLeft)) r.Views[t].RTL = true;
		});
	}
	function vv(e, r, t, a) {
		var n = { workbookViewId: '0' };
		if ((((a || {}).Workbook || {}).Views || [])[0]) n.rightToLeft = a.Workbook.Views[0].RTL ? '1' : '0';
		return yt('sheetViews', yt('sheetView', null, n), {});
	}
	function pv(e, r, t, a) {
		...
		switch (e.t) {
			...
			default:
				...
				if (a && a.bookSST) {
					f = Et('v', '' + Dd(a.Strings, e.v, a.revStrings));
					o.t = 's';
					break;
				}
				o.t = 'str';
		...
		return function f(o, l, c, h, u, d) {
			...
			for (var B = o.split(r), W = 0, H = B.length; W != H; ++W) {
				...
				for (v = 0; v != g.length; ++v) {
					...
					++w;
					E = Kr(p.slice(0, w), true);
					if (!E.r) E.r = Pa({ r: C - 1, c: y });
					T = p.slice(w);
					A = { t: '' };
					if ((m = T.match(i)) != null && m[1] !== '') A.v = Qr(m[1]);
					if (c.cellFormula) {
						if ((m = T.match(s)) != null && m[1] !== '') {
							A.f = Qr(vt(m[1]), true);
							if (!c.xlfn) A.f = Ph(A.f);
							if (m[0].indexOf('t="array"') > -1) {
								A.F = (T.match(n) || [])[1];
								if (A.F.indexOf(':') > -1) N.push([ Ua(A.F), A.F ]);
							...
							_ = Kr(m[0]);
							if (F[_.si]) A.f = Fh(F[_.si][1], F[_.si][2], E.r);
						}
						var X = Da(E.r);
						for (w = 0; w < N.length; ++w)
							if (X.r >= N[w][0].s.r && X.r <= N[w][0].e.r)
								if (X.c >= N[w][0].s.c && X.c <= N[w][0].e.c) A.F = N[w][1];
					}
					...
					switch (A.t) {
						...
						case 'str':
							A.t = 's';
							A.v = A.v != null ? Qr(vt(A.v), true) : '';
							if (c.cellHTML) A.h = it(A.v);
							break;
						case 'inlineStr':
							m = T.match(a);
							A.t = 's';
					...
					Ud(A, x, O, c, u, d);
					if (c.cellDates && R && A.t == 'n' && Pe(Y[x])) {
						A.t = 'd';
						A.v = vr(A.v);
					}
					if (E.cm && c.xlmeta) {
						var $ = (c.xlmeta.Cell || [])[+E.cm - 1];
						if ($ && $.type == 'XLDAPR') A.D = true;
					}
					if (D) {
						var K = Da(E.r);
						if (!l[K.r]) l[K.r] = [];
	...
	function mv(e, r, t, a) {
		...
		var p = { r: l },
			g,
			m = -1;
		for (u = s.s.c; u <= s.e.c; ++u) c[u] = Ra(u);
		for (h = s.s.r; h <= s.e.r; ++h) {
			...
			for (u = s.s.c; u <= s.e.c; ++u) {
				...
				if ((f = pv(b, o, e, r, t, a)) != null) i.push(f);
			}
			if (i.length > 0 || (d && d[h])) {
				p = { r: l };
				if (d && d[h]) {
	...
	function bv(e, r, t, a) {
		var n = [ zr, yt('worksheet', null, { xmlns: It[0], 'xmlns:r': Rt.r }) ];
		...
		var h = [];
		rv(o, t, e, r, n);
		n[n.length] = yt('dimension', null, { ref: l });
		n[n.length] = vv(o, r, e, t);
		if (r.sheetFormat)
			n[n.length] = yt('sheetFormatPr', null, {
		...
		if (o['!cols'] != null && o['!cols'].length > 0) n[n.length] = lv(o, o['!cols']);
		...
		if (o['!autofilter'] != null) n[n.length] = hv(o['!autofilter'], o, t, e);
		...
		if (o['!links'].length > 0) {
			...
			o['!links'].forEach(function(e) {
				...
				if ((u = e[1].Target.indexOf('#')) > -1) d.location = tt(e[1].Target.slice(u + 1));
				if (e[1].Tooltip) d.tooltip = tt(e[1].Tooltip);
				n[n.length] = yt('hyperlink', null, d);
			});
			n[n.length] = '</hyperlinks>';
		}
		delete o['!links'];
		...
		if (!r || r.ignoreEC || r.ignoreEC == void 0)
			n[n.length] = Et('ignoredErrors', yt('ignoredError', null, { numberStoredAsText: 1, sqref: l }));
		if (h.length > 0) {
			v = ni(a, -1, '../drawings/drawing' + (e + 1) + '.xml', ei.DRAW);
			n[n.length] = yt('drawing', null, { 'r:id': 'rId' + v });
			o['!drawing'] = h;
		}
		if (o['!comments'].length > 0) {
			v = ni(a, -1, '../drawings/vmlDrawing' + (e + 1) + '.vml', ei.VML);
			n[n.length] = yt('legacyDrawing', null, { 'r:id': 'rId' + v });
			o['!legacy'] = v;
		}
		if (n.length > 1) {
	...
	function kv(e, r, t) {
		...
		for (var c = 0; c < 16; ++c) {
			...
			for (var d = c << 10; d < (c + 1) << 10; ++d) {
				l.c = d;
				var v = Array.isArray(t) ? (t[l.r] || [])[l.c] : t[Pa(l)];
				if (v) {
					if (h < 0) h = d;
					u = d;
				}
	...
	function Qv(e, r, t) {
		if (t == null) t = ma(12 + 4 * e.v.length);
		rn(r, t);
		$a(e.v, t);
	...
	function cp(e, r) {
		var t = ma(50 + 4 * (e[1].Target.length + (e[1].Tooltip || '').length));
		mn({ s: Da(e[0]), e: Da(e[0]) }, t);
		hn('rId' + r, t);
	...
	function Tp(e, r) {
		if (r == null) r = ma(16 * 4 + 2);
		r._W(2, e.password ? ul(e.password) : 0);
		r._W(4, 1);
		[
			[ 'objects', false ],
			[ 'scenarios', false ],
			...
			function M(e, r, m) {
				...
				switch (m) {
					...
					case 62:
						...
						if ((g = s.CellXf[e[0].iStyleRef])) Ud(p, g.numFmtId, null, f, i, s);
						w = e[0].c == -1 ? w + 1 : e[0].c;
						if (f.dense) {
							if (!o[b]) o[b] = [];
							o[b][w] = p;
						...
						if (c.e.c < w) c.e.c = w;
						if (f.cellDates && g && p.t == 'n' && Pe(Y[g.numFmtId])) {
							var L = Z(p.v);
							if (L) {
								p.t = 'd';
					...
					case 426:
						...
						_.push(e);
						E = f.dense ? o[b][w] : o[Ra(w) + A];
						E.f = cd(e[1], c, { r: v.r, c: w }, O, f);
						E.F = Ma(e[0]);
						break;
					case 427:
						if (!f.cellFormula) break;
					...
					default:
						if (r.T) {
						} else if (!u || f.WTF) throw new Error('Unexpected record 0x' + m.toString(16));
				}
			},
			f
		);
	...
	function Lp(e, r, t, a) {
		...
		s['!comments'] = [];
		ka(n, 129);
		if (t.vbaraw || s['!outline']) ka(n, 147, Sv(f, s['!outline']));
		ka(n, 148, Ev(l));
		Fp(n, s, t.Workbook);
		Dp(n, s);
		xp(n, s, e, r, t);
		...
		_p(n, s);
		Rp(n, s, a);
		if (s['!margins']) ka(n, 476, mp(s['!margins']));
		if (!r || r.ignoreEC || r.ignoreEC == void 0) Op(n, s);
		Ip(n, s, e, a);
		ka(n, 130);
		return n.end();
	}
		...
		for (var t = 0; t != e.length; ++t) {
			...
			for (var n = 0; n != r.length; ++n) {
				...
				if (a[i[0]] == null) a[i[0]] = i[1];
					...
					switch (i[2]) {
						case 'bool':
							if (typeof a[i[0]] == 'string') a[i[0]] = lt(a[i[0]]);
							break;
						case 'int':
	...
	function $p(e, r) {
		for (var t = 0; t != r.length; ++t) {
			...
			if (e[a[0]] == null) e[a[0]] = a[1];
				...
				switch (a[2]) {
					case 'bool':
						if (typeof e[a[0]] == 'string') e[a[0]] = lt(e[a[0]]);
						break;
					case 'int':
	...
	function Yp(e) {
		...
		Xp(e.WBView, Vp);
		Xp(e.Sheets, Gp);
		Nd.date1904 = lt(e.WBProps.date1904);
	}
	function Kp(e) {
		if (!e.Workbook) return 'false';
		if (!e.Workbook.WBProps) return 'false';
		return lt(e.Workbook.WBProps.date1904) ? 'true' : 'false';
	}
	var Jp = '][*?/\\'.split('');
	function qp(e, r) {
		if (e.length > 31) {
	...
	function rg(e, r) {
		...
		var i = {},
			s = 0;
		e.replace(Xr, function f(o, l) {
			var c = Kr(o);
			switch (Jr(c[0])) {
				case '<?xml':
					break;
				case '<workbook':
					if (o.match(eg)) n = 'xmlns' + o.match(/<(\w+):/)[1];
					t.xmlns = c[n];
					break;
				case '</workbook>':
					break;
				...
				case '<workbookPr/>':
					...
					if (c.codeName) t.WBProps.CodeName = vt(c.codeName);
					break;
				case '</workbookPr>':
					break;
				...
				case '<definedName':
					{
						...
						if (lt(c.hidden || '0')) i.Hidden = true;
						s = l + o.length;
					}
					break;
				case '</definedName>':
					{
						i.Ref = Qr(vt(e.slice(s, l)));
						t.Names.push(i);
					}
					break;
				case '<definedName/>':
	...
	function tg(e) {
		var r = [ zr ];
		r[r.length] = yt('workbook', null, { xmlns: It[0], 'xmlns:r': Rt.r });
		...
		r[r.length] = '<sheets>';
		for (i = 0; i != e.SheetNames.length; ++i) {
			var s = { name: tt(e.SheetNames[i].slice(0, 31)) };
			s.sheetId = '' + (i + 1);
			s['r:id'] = 'rId' + (i + 1);
			if (n[i])
				switch (n[i].Hidden) {
		...
		if (t) {
			...
			if (e.Workbook && e.Workbook.Names)
				e.Workbook.Names.forEach(function(e) {
					...
					if (!e.Ref) return;
					r[r.length] = yt('definedName', tt(e.Ref), t);
				});
			r[r.length] = '</definedNames>';
		}
		if (r.length > 2) {
	...
	function vg(e, r) {
		...
		ka(t, 131);
		ka(t, 128, hg());
		ka(t, 153, sg((e.Workbook && e.Workbook.WBProps) || null));
		dg(t, e, r);
		cg(t, e, r);
		ka(t, 132);
		return t.end();
	...
	function pg(e, r, t) {
		if (r.slice(-4) === '.bin') return lg(e, t);
		return rg(e, t);
	}
	function gg(e, r, t, a, n, i, s, f) {
		if (r.slice(-4) === '.bin') return Cp(e, a, t, n, i, s, f);
	...
	function bg(e, r, t, a, n, i, s, f) {
		if (r.slice(-4) === '.bin') return _h(e, a, t, n, i, s, f);
		return xh(e, a, t, n, i, s, f);
	}
	function wg(e, r, t, a, n, i, s, f) {
		if (r.slice(-4) === '.bin') return yh(e, a, t, n, i, s, f);
		return Sh(e, a, t, n, i, s, f);
	}
	function kg(e, r, t, a) {
		if (r.slice(-4) === '.bin') return uc(e, t, a);
		return Kl(e, t, a);
	}
	function Tg(e, r, t) {
	...
	function Ag(e, r, t) {
		if (r.slice(-4) === '.bin') return wh(e, t);
		return lh(e, t);
	}
	function Eg(e, r, t) {
		if (r.slice(-4) === '.bin') return th(e, r, t);
		return eh(e, r, t);
	}
	function Cg(e, r, t, a) {
		if (t.slice(-4) === '.bin') return nh(e, r, t, a);
		return ah(e, r, t, a);
	}
	function yg(e, r, t) {
		if (r.slice(-4) === '.bin') return Jc(e, r, t);
		return Zc(e, r, t);
	}
	var Sg = /([\w:]+)=((?:")([^"]*)(?:")|(?:')([^']*)(?:'))/g;
	var _g = /([\w:]+)=((?:")(?:[^"]*)(?:")|(?:')(?:[^']*)(?:'))/;
	...
	function Fg(e, r, t) {
		...
		if (!t || t.cellText !== false)
			try {
				...
				} else e.w = Ig(r || 'General', e.v);
			} catch (a) {
				if (t.WTF) throw a;
			}
		try {
			var n = Rg[r] || r || 'General';
			if (t.cellNF) e.z = n;
	...
	function Dg(e, r, t) {
		if (t.cellStyles) {
			if (r.Interior) {
				var a = r.Interior;
				if (a.Pattern) a.patternType = Bl[a.Pattern] || a.Pattern;
			}
		}
		e[r.ID] = r;
	}
	function Pg(e, r, t, a, n, i, s, f, o, l) {
		var c = 'General',
			h = a.StyleID,
			u = {};
		l = l || {};
		...
		if (l.cellFormula !== false) {
			if (a.Formula) {
				...
				a.f = Oh(p, n);
				delete a.Formula;
				if (a.ArrayRange == 'RC') a.F = Oh('RC:RC', n);
				else if (a.ArrayRange) {
					a.F = Oh(a.ArrayRange, n);
					o.push([ Ua(a.F), a.F ]);
				}
			} else {
		...
		while ((o = Ot.exec(n)))
			switch ((o[3] = (X = o[3]).toLowerCase())) {
				...
				case 'style':
					...
					break;
				case 'numberformat':
					S.nf = Qr(xg(o[0]).Format || 'General');
					if (Rg[S.nf]) S.nf = Rg[S.nf];
					for (var J = 0; J != 392; ++J) if (Y[J] == S.nf) break;
					if (J == 392)
						for (J = 57; J != 392; ++J)
							if (Y[J] == null) {
								Je(S.nf, J);
				...
				case 'column':
					...
					if (!U && M.wpx > 10) {
						U = true;
						xl = yl;
						for (var q = 0; q < L.length; ++q) if (L[q]) Dl(L[q]);
					}
					if (U) Dl(M);
				...
				case 'namedrange':
					...
					if (!G.Names) G.Names = [];
					var Q = Kr(o[0]);
					var ee = { Name: Q.Name, Ref: Oh(Q.RefersTo.slice(1), { r: 0, c: 0 }) };
				...
				case 'appname':
					if (o[0].slice(-2) === '/>') break;
					else if (o[1] === '/') _i(R, X, n.slice(N, o.index));
				...
				case 'autofilter':
					if (o[1] === '/') {
						...
						var re = xg(o[0]);
						p['!autofilter'] = { ref: Oh(re.Range).replace(/\$/g, '') };
						l.push([ o[3], true ]);
					}
					break;
				case 'name':
				...
				case 'null':
					break;
				default:
					if (l.length == 0 && o[3] == 'document') return Xm(n, t);
					...
					if (l[l.length - 1][0] === 'customdocumentproperties') {
						if (o[0].slice(-2) === '/>') break;
						else if (o[1] === '/') Ng(I, X, F, n.slice(N, o.index));
						else {
							F = o;
	...
	function Bg(e, r) {
		var t = [];
		if (e.Props) t.push(xi(e.Props, r));
		if (e.Custprops) t.push(Oi(e.Props, e.Custprops, r));
		return t.join('');
	}
	function Wg() {
		return '';
	...
	function Hg(e, r) {
		...
		r.cellXfs.forEach(function(e, r) {
			var a = [];
			a.push(yt('NumberFormat', null, { 'ss:Format': tt(Y[e.numFmtId]) }));
			var n = { 'ss:ID': 's' + (21 + r) };
			t.push(yt('Style', a.join(''), n));
		});
		return yt('Styles', t.join(''));
	}
	function zg(e) {
		return yt('NamedRange', null, { 'ss:Name': e.Name, 'ss:RefersTo': '=' + Ih(e.Ref, { r: 0, c: 0 }) });
	}
	function Vg(e) {
	...
	function jg(e, r, t, a) {
		...
		if (e['!margins']) {
			n.push('<PageSetup>');
			if (e['!margins'].header) n.push(yt('Header', null, { 'x:Margin': e['!margins'].header }));
			if (e['!margins'].footer) n.push(yt('Footer', null, { 'x:Margin': e['!margins'].footer }));
			n.push(
				yt('PageMargins', null, {
		...
		if (a && a.Workbook && a.Workbook.Sheets && a.Workbook.Sheets[t]) {
			if (a.Workbook.Sheets[t].Hidden)
				n.push(yt('Visible', a.Workbook.Sheets[t].Hidden == 1 ? 'SheetHidden' : 'SheetVeryHidden', {}));
			else {
		...
		if (e['!protect']) {
			n.push(Et('ProtectContents', 'True'));
			if (e['!protect'].objects) n.push(Et('ProtectObjects', 'True'));
			if (e['!protect'].scenarios) n.push(Et('ProtectScenarios', 'True'));
			if (e['!protect'].selectLockedCells != null && !e['!protect'].selectLockedCells)
				n.push(Et('EnableSelection', 'NoSelection'));
			else if (e['!protect'].selectUnlockedCells != null && !e['!protect'].selectUnlockedCells)
				n.push(Et('EnableSelection', 'UnlockedCells'));
			[
		...
		return yt('WorksheetOptions', n.join(''), { xmlns: Nt.x });
	}
	function Xg(e) {
		return e
			.map(function(e) {
				var r = ot(e.t || '');
				var t = yt('ss:Data', r, { xmlns: 'http://www.w3.org/TR/REC-html40' });
				return yt('Comment', t, { 'ss:Author': e.a });
			})
			.join('');
	}
	function $g(e, r, t, a, n, i, s) {
		if (!e || (e.v == undefined && e.f == undefined)) return '';
		var f = {};
		if (e.f) f['ss:Formula'] = '=' + tt(Ih(e.f, s));
	...
	function Kg(e, r, t, a) {
		...
		if (e['!cols'])
			e['!cols'].forEach(function(e, r) {
				...
				var a = Pd(r, e);
				var n = { 'ss:Index': r + 1 };
				if (t) n['ss:Width'] = Ol(a.width);
				if (e.hidden) n['ss:Hidden'] = '1';
				f.push(yt('Column', null, n));
			});
	...
	function Zg(e) {
		...
		r.UnicodeClipboardFormat = Sn(t);
		a = t._R(4);
		if (a == 0 || a > 40) return r;
		t.l -= 4;
		r.Reserved2 = t._R(0, 'lpwstr');
	}
	var Qg = [ 60, 1084, 2066, 2165, 2175 ];
	function em(e, r, t, a, n) {
		var i = a;
		var s = [];
	...
	function rm(e, r, t) {
		...
		if (!r || r.cellText !== false)
			try {
				...
				} else e.w = We(a, e.v, { date1904: !!t, dateNF: r && r.dateNF });
			} catch (n) {
				if (r.WTF) throw n;
			}
		...
		while (e.l < e.length - 1) {
			...
			if (K && K.f) {
				...
				if (K.r === 2 || K.r == 12) {
					var J = e._R(2);
					$ -= 2;
					if (!R.enc && J !== X && (((J & 255) << 8) | (J >> 8)) !== X)
						throw new Error('rt mismatch: ' + J + '!=' + X);
					if (K.r == 12) {
						e.l += 10;
						$ -= 10;
					}
				...
				switch (X) {
					...
					case 24:
					case 536:
						V = { Name: q.Name, Ref: cd(q.rgce, s, null, M, R) };
						...
						if (q.Name == '_xlnm._FilterDatabase' && q.itab > 0)
							if (q.rgce && q.rgce[0] && q.rgce[0][0] && q.rgce[0][0][0] == 'PtgArea3d')
								z[q.itab - 1] = { ref: Ma(q.rgce[0][0][1][2]) };
						break;
					case 22:
						R.ExternCount = q;
						break;
					...
					case 2:
						{
							if (n['!type'] == 'chart')
								if (r.dense ? (n[q.r] || [])[q.c] : n[Pa({ c: q.c, r: q.r })]) ++q.c;
							T = { ixfe: q.ixfe, XF: E[q.ixfe] || {}, v: q.val, t: 'n' };
							if (W > 0) T.z = H[(T.ixfe >> 8) & 63];
							rm(T, r, t.opts.Date1904);
							O({ c: q.c, r: q.r }, T, r);
						}
						break;
					case 5:
							...
							if (r.cellFormula) {
								...
								if (ae && ae[0] && ae[0][0] && ae[0][0][0] == 'PtgExp') {
									var ne = ae[0][0][1][0],
										ie = ae[0][0][1][1];
									var se = Pa({ r: ne, c: ie });
									if (w[se]) T.f = '' + cd(q.formula, s, q.cell, M, R);
									else T.F = ((r.dense ? (n[ne] || [])[ie] : n[se]) || {}).F;
								} else T.f = '' + cd(q.formula, s, q.cell, M, R);
							}
							if (W > 0) T.z = H[(T.ixfe >> 8) & 63];
							rm(T, r, t.opts.Date1904);
							O(q.cell, T, r);
					...
					case 519:
						{
							if (f) {
								f.val = q;
								T = tm(q, f.cell.ixfe, 's');
								T.XF = E[T.ixfe];
								if (r.cellFormula) {
									T.f = '' + cd(f.formula, s, f.cell, M, R);
								}
								if (W > 0) T.z = H[(T.ixfe >> 8) & 63];
								rm(T, r, t.opts.Date1904);
								O(f.cell, T, r);
					...
					case 1054:
						{
							if (R.biff == 4) {
								H[W++] = q[1];
								for (var ce = 0; ce < W + 163; ++ce) if (Y[ce] == q[1]) break;
								if (ce >= 163) Je(q[1], W + 163);
							} else Je(q[1], q[0]);
						}
						break;
					case 30:
						{
							H[W++] = q;
							for (var he = 0; he < W + 163; ++he) if (Y[he] == q) break;
							if (he >= 163) Je(q, W + 163);
						}
						break;
					case 229:
						N = N.concat(q);
					...
					case 440:
						{
							for (b = q[0].s.r; b <= q[0].e.r; ++b)
								for (g = q[0].s.c; g <= q[0].e.c; ++g) {
									v = r.dense ? (n[b] || [])[g] : n[Pa({ c: g, r: b })];
									if (v) v.l = q[1];
								}
						}
						break;
					...
					case 125:
						{
							...
							while (q.e >= q.s) {
								D[q.e--] = { width: q.w / 256, level: q.level || 0, hidden: !!(q.flags & 1) };
								if (!L) {
									L = true;
									Fl(q.w / 256);
								}
					...
					case 41:
						...
						n['!margins'][{ 38: 'left', 39: 'right', 40: 'top', 41: 'bottom' }[X]] = q;
						break;
					case 161:
						if (!n['!margins']) Ld((n['!margins'] = {}));
		...
		if (e.Props) {
			...
			for (i = 0; i < s.length; ++i)
				(Object.prototype.hasOwnProperty.call(f, s[i])
					? t
					: Object.prototype.hasOwnProperty.call(o, s[i]) ? a : n).push([ s[i], e.Props[s[i]] ]);
		}
		if (e.Custprops) {
			s = nr(e.Custprops);
			for (i = 0; i < s.length; ++i)
				if (!Object.prototype.hasOwnProperty.call(e.Props || {}, s[i]))
					(Object.prototype.hasOwnProperty.call(f, s[i])
						? t
						: Object.prototype.hasOwnProperty.call(o, s[i]) ? a : n).push([ s[i], e.Custprops[s[i]] ]);
		}
		var l = [];
		for (i = 0; i < n.length; ++i) {
			if ($i.indexOf(n[i][0]) > -1 || bi.indexOf(n[i][0]) > -1) continue;
			if (n[i][1] == null) continue;
			l.push(n[i]);
		}
		if (a.length) Ze.utils.cfb_add(r, '/SummaryInformation', qi(a, nm.SI, o, Hn));
		if (t.length || l.length)
			Ze.utils.cfb_add(r, '/DocumentSummaryInformation', qi(t, nm.DSI, f, Wn, l.length ? l : null, nm.UDI));
	}
	function fm(e, r) {
		if (!r) r = {};
		Pb(r);
		...
		if (r.bookProps && !r.bookSheets) n = {};
			...
			var f = A ? 'buffer' : 'array';
			if (a && a.content) n = am(a.content, r);
			else if ((i = Ze.find(e, 'PerfectOffice_MAIN')) && i.content)
				n = Io.to_workbook(i.content, ((r.type = f), r));
			else if ((i = Ze.find(e, 'NativeContent_MAIN')) && i.content)
				n = Io.to_workbook(i.content, ((r.type = f), r));
			else if ((i = Ze.find(e, 'MN0')) && i.content) throw new Error('Unsupported Works 4 for Mac file');
			else throw new Error('Cannot find Workbook stream');
			if (r.bookVBA && e.FullPaths && Ze.find(e, '/_VBA_PROJECT_CUR/VBA/dir')) n.vbaraw = Ah(e);
		}
		var o = {};
		if (e.FullPaths) im(e, o, r);
	...
	function om(e, r) {
		...
		Ze.utils.cfb_add(a, n, Om(e, t));
		if (t.biff == 8 && (e.Props || e.Custprops)) sm(e, a);
		if (t.biff == 8 && e.vbaraw)
			Eh(a, Ze.read(e.vbaraw, { type: typeof e.vbaraw == 'string' ? 'binary' : 'buffer' }));
		return a;
	}
	var lm = {
		0: { f: wv },
	...
	function gm(e, r, t, a) {
		if (r.v != null)
			switch (r.t) {
				case 'd':
				case 'n':
					var n = r.t == 'd' ? cr(wr(r.v)) : r.v;
					if (n == (n | 0) && n >= 0 && n < 65536) hm(e, 2, ko(t, a, n));
					else hm(e, 3, bo(t, a, n));
					return;
				case 'b':
				case 'e':
					hm(e, 5, vm(t, a, r.v, r.t));
					return;
				case 's':
				case 'str':
					hm(e, 4, pm(t, a, (r.v || '').slice(0, 255)));
					return;
			}
		hm(e, 1, dm(null, t, a));
	}
	...
	function bm(e, r) {
		...
		hm(a, t.biff == 4 ? 1033 : t.biff == 3 ? 521 : 9, Vs(e, 16, t));
		mm(a, e.Sheets[e.SheetNames[n]], n, t, e);
		hm(a, 10);
		return a.end();
	}
	function wm(e, r, t) {
		hm(e, 49, cf({ sz: 12, color: { theme: 1 }, name: 'Arial', family: 2, scheme: 'minor' }, t));
	}
	function km(e, r, t) {
		if (!r) return;
		[ [ 5, 8 ], [ 23, 26 ], [ 41, 44 ], [ 50, 392 ] ].forEach(function(a) {
			for (var n = a[0]; n <= a[1]; ++n) if (r[n] != null) hm(e, 1054, gf(n, r[n], t));
		});
	}
	function Tm(e, r) {
		var t = ma(19);
	...
	function Am(e, r) {
		for (var t = 0; t < 16; ++t) hm(e, 224, yf({ numFmtId: 0, style: true }, 0, r));
	...
	function ym(e, r, t, a, n) {
		...
		if (r.bf) hm(e, 6, bd(r, t, a, n, i));
		else
			switch (r.t) {
				case 'd':
				case 'n':
					var s = r.t == 'd' ? cr(wr(r.v)) : r.v;
					hm(e, 515, If(t, a, s, i, n));
					break;
				case 'b':
				case 'e':
					hm(e, 517, Of(t, a, r.v, i, n, r.t));
					break;
				case 's':
				case 'str':
					if (n.bookSST) {
						var f = Dd(n.Strings, r.v, n.revStrings);
						hm(e, 253, uf(t, a, f, i, n));
					} else hm(e, 516, vf(t, a, (r.v || '').slice(0, 255), i, n));
					break;
				default:
					hm(e, 513, Ss(t, a, i));
			}
	...
	function Sm(e, r, t) {
		...
		if (l) hm(a, 574, ff((s.Views || [])[0]));
		if (l && (i['!merges'] || []).length) hm(a, 229, Xf(i['!merges']));
		if (l) Em(a, i);
		hm(a, 442, vs(b, r));
		if (l) Tm(a, i);
		hm(a, 10);
	...
	function _m(e, r, t) {
		...
		var f = t.biff == 8,
			o = t.biff == 5;
		hm(a, 2057, Vs(e, 5, t));
		if (t.bookType == 'xla') hm(a, 135);
		hm(a, 225, f ? ns(1200) : null);
		hm(a, 193, Qi(2));
		if (o) hm(a, 191);
		if (o) hm(a, 192);
		hm(a, 226);
		hm(a, 92, Xs('SheetJS', t));
		hm(a, 66, ns(f ? 1200 : 1252));
		if (f) hm(a, 353, ns(0));
		if (f) hm(a, 448);
		hm(a, 317, co(e.SheetNames.length));
		if (f && e.vbaraw) hm(a, 211);
		if (f && e.vbaraw) {
		...
		hm(a, 18, ts(false));
		hm(a, 19, ns(0));
		if (f) hm(a, 431, ts(false));
		if (f) hm(a, 444, ns(0));
		hm(a, 61, nf(t));
		hm(a, 64, ts(false));
		hm(a, 141, ns(0));
		hm(a, 34, ts(Kp(e) == 'true'));
		hm(a, 14, ts(true));
		if (f) hm(a, 439, ts(false));
		hm(a, 218, ns(0));
		wm(a, e, t);
		km(a, e.SSF, t);
		Am(a, t);
		if (f) hm(a, 352, ts(false));
		var c = a.end();
		var h = wa();
		if (f) hm(h, 140, to());
		if (f && t.Strings) um(h, 252, qs(t.Strings, t));
		hm(h, 10);
		var u = h.end();
		var d = wa();
		var v = 0,
		...
		for (p = 0; p < e.SheetNames.length; ++p) {
			var m = i[p] || {};
			hm(d, 133, Ks({ pos: g, hs: m.Hidden || 0, dt: 0, name: e.SheetNames[p] }, t));
			g += r[p].length;
		}
		var b = d.end();
	...
	function xm(e, r) {
		...
		Lb(t);
		t.cellXfs = [];
		Md(t.cellXfs, {}, { revssf: { General: 0 } });
		if (!e.Props) e.Props = {};
		for (var n = 0; n < e.SheetNames.length; ++n) a[a.length] = Sm(n, t, e);
		a.unshift(_m(e, a, t));
		return I(a);
	}
	function Om(e, r) {
	...
	function Rm(e, r) {
		...
		for (s = 0; s < o.length; ++s) {
			...
			for (f = 0; f < b.length; ++f) {
				...
				else if (!isNaN(Er(k))) S = { t: 'n', v: Er(k) };
				else if (!isNaN(_r(k).getDate())) {
					S = { t: 'd', v: wr(k) };
					if (!t.cellDates) S = { t: 'n', v: cr(S.v) };
					S.z = t.dateNF || Y[14];
				}
				if (t.dense) {
					if (!a[l]) a[l] = [];
	...
	function Im(e, r, t, a) {
		...
		for (var s = r.s.c; s <= r.e.c; ++s) {
			...
			var u = (h && h.v != null && (h.h || it(h.w || (Wa(h), h.w) || ''))) || '';
			var d = {};
			if (f > 1) d.rowspan = f;
			if (o > 1) d.colspan = o;
	...
	var Nm = '<html><head><meta charset="utf-8"/><title>SheetJS Table Export</title></head><body>';
	var Fm = '</body></html>';
	function Dm(e, r) {
		var t = e.match(/<table[\s\S]*?>[\s\S]*?<\/table>/gi);
		if (!t || t.length == 0) throw new Error('Invalid HTML: could not find <table>');
		if (t.length == 1) return Ha(Rm(t[0], r), r);
		var a = _w();
		t.forEach(function(e, t) {
			xw(a, Rm(e, r), 'Sheet' + (t + 1));
		});
		return a;
	}
	function Pm(e, r, t) {
	...
	function Lm(e, r) {
		var t = r || {};
		var a = t.header != null ? t.header : Nm;
		var n = t.footer != null ? t.footer : Fm;
		var i = [ a ];
		var s = La(e['!ref']);
		t.dense = Array.isArray(e);
		i.push(Pm(e, s, t));
		for (var f = s.s.r; f <= s.e.r; ++f) i.push(Im(e, s, f, t));
		i.push('</table>' + n);
		return i.join('');
	}
	function Mm(e, r, t) {
		...
		for (; v < f.length && p < o; ++v) {
			...
			for (g = b = 0; g < A.length; ++g) {
				var E = A[g];
				if (a.display && Wm(E)) continue;
				var C = E.hasAttribute('data-v')
					? E.getAttribute('data-v')
					: E.hasAttribute('v') ? E.getAttribute('v') : mt(E.innerHTML);
				...
				if (C != null) {
					...
					else if (!isNaN(Er(C))) _ = { t: 'n', v: Er(C) };
					else if (!isNaN(_r(C).getDate())) {
						_ = { t: 'd', v: wr(C) };
						if (!a.cellDates) _ = { t: 'n', v: cr(_.v) };
						_.z = a.dateNF || Y[14];
					}
				}
		...
		e['!ref'] = Ma(l);
		if (p >= o) e['!fullref'] = Ma(((l.e.r = f.length - v + p - 1 + n), l));
		return e;
	}
	function Um(e, r) {
		var t = r || {};
	...
	function Gm(e, r) {
		...
		while ((p = Ot.exec(a)))
			switch ((p[3] = p[3].replace(/_.*$/, ''))) {
				...
				case '工作表':
					if (p[1] === '/') {
						if (y.e.c >= y.s.c && y.e.r >= y.s.r) v['!ref'] = Ma(y);
						else v['!ref'] = 'A1:A1';
				...
				case '行':
					...
					if (F < 10) for (j = 0; j < F; ++j) if (S > 0) N[E + j] = { level: S };
					C = -1;
					break;
				...
				case '数据':
					if (p[0].charAt(p[0].length - 2) === '/') {
						...
						g = { t: 'z', v: null };
						if (b.formula && t.cellFormula != false) g.f = _d(Qr(b.formula));
						if ((b['数据类型'] || b['value-type']) == 'string') {
							g.t = 's';
							g.v = Qr(b['string-value'] || '');
							if (t.dense) {
								if (!v[E]) v[E] = [];
								v[E][C] = g;
							} else {
						...
						if (t.cellFormula) {
							if (b.formula) b.formula = Qr(b.formula);
							...
							if (b.formula) g.f = _d(b.formula);
							else
								for (j = 0; j < P.length; ++j)
									if (E >= P[j][0].s.r && E <= P[j][0].e.r)
										if (C >= P[j][0].s.c && C <= P[j][0].e.c) g.F = P[j][1];
						}
						...
						if (b['number-columns-repeated']) D = parseInt(b['number-columns-repeated'], 10);
						switch (g.t) {
							case 'boolean':
								g.t = 'b';
								g.v = lt(b['boolean-value']);
								break;
							case 'float':
								g.t = 'n';
							...
							if (!(t.sheetRows && t.sheetRows <= E)) {
								for (var $ = 0; $ < F; ++$) {
									...
									if (t.dense) {
										if (!v[E + $]) v[E + $] = [];
										v[E + $][C] = $ == 0 ? g : Tr(g);
										while (--D > 0) v[E + $][C + D] = Tr(g);
									} else {
										v[Pa({ r: E + $, c: C })] = g;
										while (--D > 0) v[Pa({ r: E + $, c: C + D })] = Tr(g);
									}
									if (y.e.c <= C) y.e.c = C;
								}
							}
				...
				case 'database-range':
					if (p[1] === '/') break;
					try {
						U = Od(Kr(p[0])['target-range-address']);
	...
	var Ym = (function() {
				...
				for (; o <= l.e.c; ++o) {
					...
					switch (w.t) {
						...
						case 'str':
							...
							break;
						case 'd':
							m = w.w || wr(w.v).toISOString();
							g['office:value-type'] = 'date';
							g['office:date-value'] = wr(w.v).toISOString();
					...
					if (w.l && w.l.Target) {
						var A = w.l.Target;
						A = A.charAt(0) == '#' ? '#' + Rd(A.slice(1)) : A;
						if (A.charAt(0) != '#' && !A.match(/^\w+:/)) A = '../' + A;
						T = yt('text:a', T, { 'xlink:href': A.replace(/&/g, '&amp;') });
					}
					s.push('          ' + yt('table:table-cell', yt('text:p', T, {}), g) + '\n');
				}
		...
		return function i(e, r) {
			...
			if (r.bookType == 'fods') {
				...
				t.push(hi().replace(/office:document-meta/g, 'office:meta'));
	...
	function Km(e, r) {
		if (r.bookType == 'fods') return Ym(e, r);
		var t = Br();
		var a = '';
		var n = [];
		var i = [];
	...
	function qm(e) {
		return typeof TextDecoder != 'undefined' ? new TextDecoder().decode(e) : vt(x(e));
	}
	function Zm(e) {
		return typeof TextEncoder != 'undefined' ? new TextEncoder().encode(e) : S(pt(e));
	}
	function Qm(e, r) {
	...
	function cb(e) {
		...
		while (a[0] < e.length) {
			var n = nb(e, a);
			var i = fb(e.slice(a[0], a[0] + n));
			a[0] += n;
			var s = { id: sb(i[1][0].data), messages: [] };
			...
			if ((r = i[3]) == null ? void 0 : r[0]) s.merge = sb(i[3][0].data) >>> 0 > 0;
			t.push(s);
		}
		return t;
	}
	function hb(e) {
		...
		e.forEach(function(e) {
			...
			e.messages.forEach(function(e) {
				...
				t[2].push({ data: ob(e.meta), type: 2 });
			});
			var n = ob(t);
			r.push(ib(n.length));
			r.push(n);
	...
	function pb(e, r, t, a) {
		...
		var s = (a > 1 ? 12 : 8) + rb(i & (a > 1 ? 3470 : 398)) * 4;
		var f = -1,
			o = -1,
			l = NaN,
			c = new Date(2001, 0, 1);
			...
			case 9:
				{
					if (s > -1) h = { t: 's', v: t[s] };
						...
						throw new Error(
							'Unsupported cell type '.concat(e[1], ' : ').concat(n & 31, ' : ').concat(e.slice(0, 4))
						);
				}
				break;
			case 10:
	...
	function Ab(e, r) {
		...
		(n || []).forEach(function(r) {
			...
			switch (a) {
				...
				case 8:
					{
						var s = e[kb(t[9][0].data)][0];
						var f = fb(s.data);
						var o = e[kb(f[1][0].data)][0];
						var l = sb(o.meta[1][0].data);
	...
	function Eb(e, r) {
		...
		var g = fb(e);
		var m = sb(g[1][0].data) >>> 0;
		var b = sb(g[2][0].data) >>> 0;
		var w = (((a = (t = g[8]) == null ? void 0 : t[0]) == null ? void 0 : a.data) && sb(g[8][0].data) > 0) || false;
		var k, T;
	...
	function Cb(e, r) {
		...
		if ((t = a == null ? void 0 : a[7]) == null ? void 0 : t[0]) {
			if (sb(a[7][0].data) >>> 0) n = 1;
			else n = 0;
		}
		var i = lb(a[5], function(e) {
			return Eb(e, n);
		});
		return {
			nrows: sb(a[4][0].data) >>> 0,
	...
	function yb(e, r, t) {
		...
		f.e.r = (sb(s[6][0].data) >>> 0) - 1;
		if (f.e.r < 0) throw new Error('Invalid row varint '.concat(s[6][0].data));
		f.e.c = (sb(s[7][0].data) >>> 0) - 1;
		if (f.e.c < 0) throw new Error('Invalid col varint '.concat(s[7][0].data));
		t['!ref'] = Ma(f);
		var o = fb(s[4][0].data);
		var l = Ab(e, e[kb(o[4][0].data)][0]);
		var c = ((a = o[17]) == null ? void 0 : a[0]) ? Ab(e, e[kb(o[17][0].data)][0]) : [];
		var h = fb(o[3][0].data);
		var u = 0;
		h[1].forEach(function(r) {
			var a = fb(r.data);
			var n = e[kb(a[2][0].data)][0];
			var i = sb(n.meta[1][0].data);
		...
		if ((n = o[13]) == null ? void 0 : n[0]) {
			var d = e[kb(o[13][0].data)][0];
			var v = sb(d.meta[1][0].data);
			...
			t['!merges'] =
				(i = fb(d.data)) == null
					...
					: i[1].map(function(e) {
							var r = fb(e.data);
							var t = Jm(fb(r[1][0].data)[1][0].data),
								a = Jm(fb(r[2][0].data)[1][0].data);
							return {
	...
	function Sb(e, r) {
		var t = fb(r.data);
		var a = { '!ref': 'A1' };
		var n = e[kb(t[2][0].data)];
		var i = sb(n[0].meta[1][0].data);
	...
	function _b(e, r) {
		var t;
		var a = fb(r.data);
		var n = { name: ((t = a[1]) == null ? void 0 : t[0]) ? qm(a[1][0].data) : '', sheets: [] };
		var i = lb(a[2], kb);
		i.forEach(function(r) {
			e[r].forEach(function(r) {
				var t = sb(r.meta[1][0].data);
				if (t == 6e3) n.sheets.push(Sb(e, r));
			});
		});
		return n;
	}
			...
			e[r].forEach(function(r) {
				...
				if (t == 2) {
					...
					n.sheets.forEach(function(e, r) {
						xw(a, e, r == 0 ? n.name : n.name + '_' + r, true);
					});
				}
			});
		});
	...
	function Ob(e) {
		...
		if (
			((n =
				(a = (t = (r = l == null ? void 0 : l[1]) == null ? void 0 : r[0]) == null ? void 0 : t.meta) == null
					? void 0
					: a[1]) == null
				? void 0
				: n[0].data) &&
			sb(l[1][0].meta[1][0].data) == 1e4
		)
			throw new Error('Pages documents are not supported');
		var h =
			((o =
				(f = (s = (i = l == null ? void 0 : l[1]) == null ? void 0 : i[0]) == null ? void 0 : s.meta) == null
					? void 0
					: f[1]) == null
				? void 0
				: o[0].data) &&
			sb(l[1][0].meta[1][0].data) == 1 &&
			l[1][0];
		if (!h)
			c.forEach(function(e) {
				l[e].forEach(function(e) {
					var r = sb(e.meta[1][0].data) >>> 0;
					if (r == 1) {
						if (!h) h = e;
	...
	function Rb(e, r, t, a) {
		var n, i;
		if (!((n = e[6]) == null ? void 0 : n[0]) || !((i = e[7]) == null ? void 0 : i[0]))
	...
	function Fb(e, r) {
		...
		var o = {};
		var l = [];
		var c = Ze.read(r.numbers, { type: 'base64' });
		c.FileIndex
			.map(function(e, r) {
			...
			.forEach(function(e) {
				...
				i.forEach(function(e) {
					l.push(e.id);
					o[e.id] = { deps: [], location: t, type: sb(e.messages[0].meta[1][0].data) };
				});
			});
		l.sort(function(e, r) {
			return e - r;
		...
		c.FileIndex
			...
			.forEach(function(e) {
				var r = e[0];
				if (!r.name.match(/\.iwa/)) return;
				var t = cb(db(r.content));
				t.forEach(function(e) {
					h.forEach(function(r) {
						if (
							e.messages.some(function(e) {
								return sb(e.meta[1][0].data) != 11006 && Qm(e.data, r[1]);
							})
						) {
		...
		var d = Ze.find(c, o[1].location);
		var v = cb(db(d.content));
		var p;
		for (var g = 0; g < v.length; ++g) {
			var m = v[g];
			if (m.id == 1) p = m;
		}
		var b = kb(fb(p.messages[0].data)[1][0].data);
		d = Ze.find(c, o[b].location);
		v = cb(db(d.content));
		for (g = 0; g < v.length; ++g) {
			m = v[g];
			if (m.id == b) p = m;
		}
		var w = fb(p.messages[0].data);
		{
			w[1] = [ { type: 2, data: Zm(e.SheetNames[0]) } ];
		}
		p.messages[0].data = ob(w);
		d.content = vb(hb(v));
		...
		b = kb(fb(p.messages[0].data)[2][0].data);
		d = Ze.find(c, o[b].location);
		v = cb(db(d.content));
		for (g = 0; g < v.length; ++g) {
			m = v[g];
		...
		var k = fb(p.messages[0].data);
		{
			k[6][0].data = ib(n.e.r + 1);
			k[7][0].data = ib(n.e.c + 1);
			var T = kb(k[46][0].data);
			var A = Ze.find(c, o[T].location);
			var E = cb(db(A.content));
			{
				for (var C = 0; C < E.length; ++C) {
					if (E[C].id == T) break;
				}
				if (E[C].id != T) throw 'Bad ColumnRowUIDMapArchive';
				var y = fb(E[C].messages[0].data);
				y[1] = [];
				(y[2] = []), (y[3] = []);
				for (var S = 0; S <= n.e.c; ++S) {
					y[1].push({
						type: 2,
						data: ob([ [], [ { type: 0, data: ib(S + 420690) } ], [ { type: 0, data: ib(S + 420690) } ] ])
					});
					y[2].push({ type: 0, data: ib(S) });
					y[3].push({ type: 0, data: ib(S) });
				}
				y[4] = [];
				(y[5] = []), (y[6] = []);
				for (var _ = 0; _ <= n.e.r; ++_) {
					y[4].push({
						type: 2,
						data: ob([ [], [ { type: 0, data: ib(_ + 726270) } ], [ { type: 0, data: ib(_ + 726270) } ] ])
					});
					y[5].push({ type: 0, data: ib(_) });
					y[6].push({ type: 0, data: ib(_) });
				}
				E[C].messages[0].data = ob(y);
			}
			A.content = vb(hb(E));
			...
			var x = fb(k[4][0].data);
			{
				x[7][0].data = ib(n.e.r + 1);
				var O = fb(x[1][0].data);
				var R = kb(O[2][0].data);
				A = Ze.find(c, o[R].location);
				E = cb(db(A.content));
				{
					if (E[0].id != R) throw 'Bad HeaderStorageBucket';
					var I = fb(E[0].messages[0].data);
					if ((t = I == null ? void 0 : I[2]) == null ? void 0 : t[0])
						for (_ = 0; _ < s.length; ++_) {
							var N = fb(I[2][0].data);
							N[1][0].data = ib(_);
							N[4][0].data = ib(s[_].length);
							I[2][_] = { type: I[2][0].type, data: ob(N) };
						}
					E[0].messages[0].data = ob(I);
				}
				A.content = vb(hb(E));
				A.size = A.content.length;
				var F = kb(x[2][0].data);
				A = Ze.find(c, o[F].location);
				E = cb(db(A.content));
				{
					if (E[0].id != F) throw 'Bad HeaderStorageBucket';
					I = fb(E[0].messages[0].data);
					for (S = 0; S <= n.e.c; ++S) {
						N = fb(I[2][0].data);
						N[1][0].data = ib(S);
						N[4][0].data = ib(n.e.r + 1);
						I[2][S] = { type: I[2][0].type, data: ob(N) };
					}
					E[0].messages[0].data = ob(I);
				}
				A.content = vb(hb(E));
				...
				if (a['!merges']) {
											...
											[
												{
													type: 5,
													data: new Uint8Array(
														new Uint16Array([ e.e.r - e.s.r + 1, e.e.c - e.s.c + 1 ]).buffer
													)
												}
											]
										])
					...
					x[13] = [ { type: 2, data: Tb(D) } ];
					v.push({ id: D, messages: [ Ib(6144, ob(P)) ] });
				}
				var L = kb(x[4][0].data);
				(function() {
					var e = Ze.find(c, o[L].location);
					var r = cb(db(e.content));
					var t;
					for (var a = 0; a < r.length; ++a) {
						var n = r[a];
						if (n.id == L) t = n;
					}
					var i = fb(t.messages[0].data);
					{
						i[3] = [];
				...
				{
					var U = M[1][0];
					M[3] = [ { type: 0, data: ib(Nb ? 1 : 0) } ];
					var B = fb(U.data);
					{
						var W = kb(B[2][0].data);
						(function() {
							var e = Ze.find(c, o[W].location);
							var r = cb(db(e.content));
							var t;
							for (var a = 0; a < r.length; ++a) {
								var i = r[a];
							...
							var l = fb(t.messages[0].data);
							{
								...
								for (var u = 0; u <= n.e.r; ++u) {
									...
									Rb(d, s[u], f, Nb);
									d[1][0].data = ib(u);
									l[5].push({ data: ob(d), type: 2 });
								}
								l[1] = [ { type: 0, data: ib(0) } ];
								l[2] = [ { type: 0, data: ib(0) } ];
								l[3] = [ { type: 0, data: ib(0) } ];
								l[4] = [ { type: 0, data: ib(n.e.r + 1) } ];
								l[6] = [ { type: 0, data: ib(5) } ];
								l[7] = [ { type: 0, data: ib(1) } ];
								l[8] = [ { type: 0, data: ib(Nb ? 1 : 0) } ];
							}
							t.messages[0].data = ob(l);
							e.content = vb(hb(r));
							e.size = e.content.length;
						})();
					}
	...
	function Ub(e, r) {
		...
		try {
			e = r.map(function a(r) {
				...
				return [ r.name, e['!id'][r.id].Target, Mb(e['!id'][r.id].Type) ];
			});
		} catch (t) {
			return null;
		}
	...
	function Bb(e, r, t, a, n, i, s, f, o, l, c, h) {
		try {
			...
			switch (f) {
				...
				case 'chart':
					...
					var p = ri(v);
					var g = ih(Pr(e, v, true), ti(Pr(e, p, true), v));
					var m = Hr(g, v);
					var b = ri(m);
					d = Up(Pr(e, m, true), m, o, ti(Pr(e, b, true), m), l, d);
					break;
				case 'macro':
					d = bg(u, r, n, o, i[a], l, c, h);
					break;
				case 'dialog':
					d = wg(u, r, n, o, i[a], l, c, h);
					break;
				default:
			...
			var w = [];
			if (i && i[a])
				nr(i[a]).forEach(function(t) {
					var n = '';
					if (i[a][t].Type == ei.CMNT) {
						n = Hr(i[a][t].Target, r);
						var s = Ag(Dr(e, n, true), n, o);
						if (!s || !s.length) return;
						oh(d, s, false);
					}
					if (i[a][t].Type == ei.TCMNT) {
						n = Hr(i[a][t].Target, r);
						w = w.concat(hh(Dr(e, n, true), o));
					}
				});
			if (w && w.length) oh(d, w, true, o.people || []);
		} catch (k) {
			if (o.WTF) throw k;
		}
	}
	...
	function Hb(e, r) {
		...
		r = r || {};
		Pb(r);
		if (Nr(e, 'META-INF/manifest.xml')) return jm(e, r);
		if (Nr(e, 'objectdata.xml')) return jm(e, r);
		if (Nr(e, 'Index/Document.iwa')) {
			if (typeof Uint8Array == 'undefined') throw new Error('NUMBERS file parsing requires Uint8Array support');
			if (typeof Ob != 'undefined') {
				if (e.FileIndex) return Ob(e);
		...
		if (!r.bookSheets && !r.bookProps) {
			...
			if (n.sst)
				try {
					Id = Tg(Dr(e, Wb(n.sst)), n.sst, r);
				} catch (c) {
					if (r.WTF) throw c;
				}
			if (r.cellStyles && n.themes.length) o = Fc(Pr(e, n.themes[0].replace(/^\//, ''), true) || '', r);
			if (n.style) l = kg(Dr(e, Wb(n.style)), n.style, o, r);
		}
		n.links.map(function(t) {
			try {
				var a = ti(Pr(e, ri(Wb(t))), t);
				return Cg(Dr(e, Wb(t)), a, t, r);
			} catch (n) {}
		});
		var h = pg(Dr(e, Wb(n.workbooks[0])), n.workbooks[0], r);
		var u = {},
			d = '';
		if (n.coreprops.length) {
			d = Dr(e, Wb(n.coreprops[0]), true);
			if (d) u = vi(d);
			if (n.extprops.length !== 0) {
				d = Dr(e, Wb(n.extprops[0]), true);
				if (d) ki(d, u, r);
			}
		}
		var v = {};
		...
		s = {};
		var g = {};
		if (r.bookDeps && n.calcchain) g = Eg(Dr(e, Wb(n.calcchain)), n.calcchain, r);
		var m = 0;
		var b = {};
		var w, k;
		{
		...
		if (!Nr(e, y)) y = 'xl/_rels/workbook.' + E + '.rels';
		var S = ti(Pr(e, y, true), y.replace(/_rels.*/, 's5s'));
		if ((n.metadata || []).length >= 1) {
			r.xlmeta = yg(Dr(e, Wb(n.metadata[0])), n.metadata[0], r);
		}
		if ((n.people || []).length >= 1) {
			r.people = dh(Dr(e, Wb(n.people[0])), r);
		}
		if (S) S = Ub(S, h.Sheets);
		var _ = Dr(e, 'xl/worksheets/sheet.xml', true) ? 1 : 0;
		e: for (m = 0; m != u.Worksheets; ++m) {
			var x = 'sheet';
			if (S && S[m]) {
				w = 'xl/' + S[m][1].replace(/[\/]?xl\//, '');
				if (!Nr(e, w)) w = S[m][1];
				if (!Nr(e, w)) w = y.replace(/_rels\/.*$/, '') + S[m][1];
				x = S[m][2];
			} else {
			...
			Bb(e, w, k, u.SheetNames[m], m, b, s, x, r, h, o, l);
		}
		p = {
			Directory: n,
			Workbook: h,
		...
		if (r && r.bookVBA) {
			if (n.vba.length > 0) p.vbaraw = Dr(e, Wb(n.vba[0]), true);
			else if (n.defaults && n.defaults.bin === Th) p.vbaraw = Dr(e, 'xl/vbaProject.bin', true);
		}
		return p;
	}
	function zb(e, r) {
		...
		for (f = 1; f <= e.SheetNames.length; ++f) {
			...
			if (h) {
				...
				if (d && d.length > 0) {
					...
					Ur(i, p, kh(d, r));
					n.comments.push(p);
					ni(c, -1, '../comments' + f + '.' + t, ei.CMNT);
					v = true;
				}
				if (h['!legacy']) {
					if (v) Ur(i, 'xl/drawings/vmlDrawing' + f + '.vml', sh(f, h['!comments']));
				}
				delete h['!comments'];
				delete h['!legacy'];
			}
			if (c['!id'].rId1) Ur(i, ri(s), ai(c));
		}
		...
		for (f = 1; f <= e.SheetNames.length; ++f) {
			...
			if (u) {
				...
				if (v && v.length > 0) {
					...
					if (m) {
						g = 'xl/threadedComments/threadedComment' + f + '.xml';
						Ur(i, g, uh(v, c, r));
						n.threadedcomments.push(g);
						ni(h, -1, '../threadedComments/threadedComment' + f + '.xml', ei.TCMNT);
					}
					g = 'xl/comments' + f + '.' + t;
					Ur(i, g, ch(v, r));
					n.comments.push(g);
					ni(h, -1, '../comments' + f + '.' + t, ei.CMNT);
					p = true;
				}
				if (u['!legacy']) {
					if (p) Ur(i, 'xl/drawings/vmlDrawing' + f + '.vml', sh(f, u['!comments']));
				}
				delete u['!comments'];
				delete u['!legacy'];
			}
			if (h['!id'].rId1) Ur(i, ri(s), ai(h));
		}
		if (r.Strings != null && r.Strings.length > 0) {
			s = 'xl/sharedStrings.' + t;
	...
	function Xb(e, r) {
		if (Ze.find(e, 'EncryptedPackage')) return zb(e, r);
		return fm(e, r);
	}
	function $b(e, r) {
		var t,
			a = e;
		var n = r || {};
		if (!n.type) n.type = A && Buffer.isBuffer(e) ? 'buffer' : 'base64';
		t = Wr(a, n);
		return Hb(t, n);
	}
	function Yb(e, r) {
	...
	function Zb(e, r, t, a) {
		if (a) {
			t.type = 'string';
			return Oo.to_workbook(e, t);
		}
		return Oo.to_workbook(r, t);
	}
	function Qb(e, r) {
		l();
		var t = r || {};
		if (typeof ArrayBuffer !== 'undefined' && e instanceof ArrayBuffer)
			return Qb(new Uint8Array(e), ((t = Tr(t)), (t.type = 'array'), t));
		...
		if (!t.type) t.type = A && Buffer.isBuffer(e) ? 'buffer' : 'base64';
		if (t.type == 'file') {
			t.type = A ? 'buffer' : 'binary';
			a = ar(e);
			if (typeof Uint8Array !== 'undefined' && !A) t.type = 'array';
		}
		if (t.type == 'string') {
			i = true;
			t.type = 'binary';
		...
		switch ((n = jb(a, t))[0]) {
			case 208:
				if (
					...
					return Xb(Ze.read(a, t), t);
				break;
			case 9:
				if (n[1] <= 8) return fm(a, t);
				break;
			case 60:
				return Ug(a, t);
			case 73:
				if (n[1] === 73 && n[2] === 42 && n[3] === 0) throw new Error('TIFF Image File is not a spreadsheet');
				if (n[1] === 68) return Ro(a, t);
				break;
			case 84:
				if (n[1] === 65 && n[2] === 66 && n[3] === 76) return _o.to_workbook(a, t);
				break;
			case 80:
				return n[1] === 75 && n[2] < 9 && n[3] < 9 ? $b(a, t) : Zb(e, a, t, i);
			case 239:
				return n[3] === 60 ? Ug(a, t) : Zb(e, a, t, i);
			case 255:
				if (n[1] === 254) {
					return Jb(a, t);
			...
			case 139:
			case 140:
				return yo.to_workbook(a, t);
			case 123:
				if (n[1] === 92 && n[2] === 114 && n[3] === 116) return wl.to_workbook(a, t);
				break;
			case 10:
			case 13:
			case 32:
		...
		if (Co.indexOf(n[0]) > -1 && n[2] <= 12 && n[3] <= 31) return yo.to_workbook(a, t);
		return Zb(e, a, t, i);
	}
	function ew(e, r) {
		var t = r || {};
	...
	function rw(e, r) {
		switch (r.type) {
			...
			case 'array':
				...
				break;
			case 'file':
				return tr(r.file, Ze.write(e, { type: A ? 'buffer' : '' }));
			case 'string':
	...
	function iw(e, r) {
		var t = {};
		var a = A ? 'nodebuffer' : typeof Uint8Array !== 'undefined' ? 'array' : 'string';
	...
	function hw(e, r) {
		...
		switch (t.bookType || 'xlsb') {
			...
			case 'slk':
			case 'sylk':
				return fw(So.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
			case 'htm':
			case 'html':
				return fw(Lm(e.Sheets[e.SheetNames[n]], t), t);
			case 'txt':
				return ow(Tw(e.Sheets[e.SheetNames[n]], t), t);
			case 'csv':
				return fw(kw(e.Sheets[e.SheetNames[n]], t), t, '\ufeff');
			case 'dif':
				return fw(_o.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
			case 'dbf':
				return lw(yo.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
			case 'prn':
				return fw(Oo.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
			case 'rtf':
				return fw(wl.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
			case 'eth':
				return fw(xo.from_sheet(e.Sheets[e.SheetNames[n]], t), t);
			case 'fods':
				return fw(Km(e, t), t);
			case 'wk1':
				return lw(Io.sheet_to_wk1(e.Sheets[e.SheetNames[n]], t), t);
			case 'wk3':
				return lw(Io.book_to_wk3(e, t), t);
			case 'biff2':
				if (!t.biff) t.biff = 2;
			case 'biff3':
				if (!t.biff) t.biff = 3;
	...
	function pw(e, r, t, a) {
		...
		return Qe.writeFile(e, hw(r, n), i);
	}
			...
			for (var v = r.s.c; v <= r.e.c; ++v) {
				...
				if (i[v] != null) {
					if (g == null) {
						...
						u[i[v]] = c && (p.t !== 'n' || (p.t === 'n' && f.rawNumbers !== false)) ? g : Wa(p, g, f);
					}
					if (g != null) h = false;
				}
			}
	...
	function ww(e, r, t, a, n, i, s, f) {
		...
		for (var u = r.s.c; u <= r.e.c; ++u) {
			...
			if (d == null) c = '';
				...
				o = false;
				c = '' + (f.rawNumbers && d.t == 'n' ? d.v : Wa(d, null, f));
	...
	function kw(e, r) {
		...
		for (var v = n.s.c; v <= n.e.c; ++v) if (!(u[v] || {}).hidden) h[v] = Ra(v);
		var p = 0;
		for (var g = n.s.r; g <= n.e.r; ++g) {
			if ((d[g] || {}).hidden) continue;
			c = ww(e, n, g, h, s, o, i, a);
			if (c == null) {
				continue;
			}
	...
	function Aw(e) {
		...
		for (f = n.s.c; f <= n.e.c; ++f) s[f] = Ra(f);
	...
	function Ew(e, r, t) {
		...
		var v = Sa(s);
		if (n) for (d = 0; d < u.length; ++d) i[Ra(d + f) + v] = { t: 's', v: u[d] };
		i['!ref'] = Ma(c);
		return i;
	}
	function Cw(e, r) {
	...
	function yw(e, r, t) {
		...
		if (typeof r != 'number') return yw(e, Pa(r));
		return yw(e, Pa({ r: r, c: t || 0 }));
	}
	function Sw(e, r) {
		if (typeof r == 'number') {
	...
	var Pw = {
		...
		sheet_to_row_object_array: mw,
		sheet_get_cell: yw,
		book_new: _w,
		book_append_sheet: xw,
		book_set_sheet_visibility: Ow,
		cell_set_number_format: Rw,
	...
	function Bw(e, r) {
		var t = Lw();
		var a = r || {};
		var n = a.header != null ? a.header : Nm;
		var i = a.footer != null ? a.footer : Fm;
		t.push(n);
		var s = La(e['!ref']);
		a.dense = Array.isArray(e);
		t.push(Pm(e, s, a));
	...
	var Hw = { to_json: Ww, to_html: Bw, to_csv: Uw, set_readable: Mw };
	if (typeof fm !== 'undefined') e.parse_xlscfb = fm;
	e.parse_zip = Hb;
	e.read = Qb;
	e.readFile = ew;
	e.readFileSync = ew;
